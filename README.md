...
```bash
npm run dev:all      # Empfohlen: API (3001) + Vite (3000) in einem Befehl
npm run dev          # Nur Vite (3000) — braucht zusätzlich dev:server
npm run dev:server   # Nur Express API (3001)
