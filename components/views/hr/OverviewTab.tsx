    ...
    return (
        <div className="animate-fade-in flex flex-col lg:flex-row gap-6">
            ...
            <div className="flex-1 min-w-0 space-y-6 order-2 lg:order-1">
                ...
                {isHR && (
                    <div>
                        <h3 className="text-[10px] font-black text-slate-500 uppercase tracking-widest mb-3 px-1">HR Kommandozentrale</h3>
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                            ...
                            >
                                ...
                                <div className="min-w-0">
                                    <p className="text-[10px] font-black text-indigo-300 uppercase tracking-widest">Fallakten</p>
                                    <p className="text-2xl font-black text-white tabular-nums mt-0.5">{stats.pendingCases}</p>
                                    <p className="text-[10px] text-slate-500 uppercase tracking-wider">Ausstehende Überprüfung</p>
                                </div>
                            </button>
                            ...
                            >
                                ...
                                <div className="min-w-0">
                                    ...
                                    <p className="text-[10px] text-slate-500 uppercase tracking-wider">Geplant</p>
                                </div>
                            </button>
                            ...
                            >
                                ...
                                <div className="min-w-0">
                                    <p className="text-[10px] font-black text-emerald-300 uppercase tracking-widest">Stellenangebote</p>
                                    <p className="text-2xl font-black text-white tabular-nums mt-0.5">{stats.openVacancies}</p>
                                    <p className="text-[10px] text-slate-500 uppercase tracking-wider">Offene Stellen</p>
                                </div>
                            </button>
                        </div>
                    </div>
                ...
                <div className="bg-slate-900/60 backdrop-blur-md border border-slate-700/50 rounded-xl px-4 sm:px-5 py-3.5">
                    <div className="flex items-center flex-wrap gap-x-5 sm:gap-x-8 gap-y-3">
                        <div className="flex items-center gap-2.5">
                            ...
                            <span className="text-[10px] text-slate-500 uppercase tracking-widest font-black">Ruf</span>
                        </div>
                        ...
                        <div className="flex items-center gap-2.5">
                            ...
                            <span className="text-[10px] text-slate-500 uppercase tracking-widest font-black">Missionen</span>
                        </div>
                        <div className="h-5 w-px bg-slate-700/80 hidden sm:block"></div>
                        <div className="flex items-center gap-2.5">
                            ...
                            <span className="text-[10px] text-slate-500 uppercase tracking-widest font-black">Durchschnittliche Bewertung</span>
                        </div>
                    </div>
                </div>
                ...
                {/* Career Timeline */}
                <div>
                    <h3 className="text-[10px] font-black text-slate-500 uppercase tracking-widest mb-3 px-1">Karriere-Timeline</h3>
                    <div className="bg-slate-900/60 backdrop-blur-md border border-slate-700/50 rounded-xl p-5">
                        {careerEvents.length > 0 ? (
                            ...
                            <p className="text-sm text-slate-500 italic text-center py-4">Es sind noch keine Karriereereignisse verzeichnet.</p>
                        )}
                    </div>
                </div>
            </div>
            ...
            <aside className="lg:w-80 lg:shrink-0 space-y-4 order-1 lg:order-2">
                ...
                <div>
                    <div className="flex items-center justify-between mb-2 px-1">
                        <h3 className="text-[10px] font-black text-slate-500 uppercase tracking-widest">Spezialisierungen</h3>
                        <button
                    ...
                    <div className="bg-slate-900/60 backdrop-blur-md border border-slate-700/50 rounded-xl p-3">
                        {currentUser?.specializations && currentUser.specializations.length > 0 ? (
                            ...
                            >
                                <i className="fa-solid fa-tags mr-1.5"></i>Noch keine – klicken du, um auszuwählen</button>
                        )}
                    </div>
                </div>
                ...
                {/* Quick Options */}
                <div>
                    <h3 className="text-[10px] font-black text-slate-500 uppercase tracking-widest mb-2 px-1">Schnelloptionen</h3>
                    <div className="bg-slate-900/60 backdrop-blur-md border border-slate-700/50 rounded-xl overflow-hidden divide-y divide-slate-800/80">
                        ...
                        >
                            ...
                            <div className="min-w-0 flex-1">
                                <p className="text-sm font-bold text-white leading-tight">Stellenanzeiger</p>
                                <p className="text-[10px] text-slate-500 uppercase tracking-wider">Anzeigen & anwenden</p>
                            </div>
                        ...
                        >
                            ...
                            <div className="min-w-0 flex-1">
                                <p className="text-sm font-bold text-white leading-tight">Transfereinheit</p>
                                <p className="text-[10px] text-slate-500 uppercase tracking-wider">Änderung beantragen</p>
                            </div>
                            <i className="fa-solid fa-chevron-right text-slate-600 group-hover:text-slate-400 text-xs"></i>
                        </button>
                        <button
                        ...
                        >
                            ...
                            <div className="min-w-0 flex-1">
                                <p className="text-sm font-bold text-white leading-tight">Freigabe</p>
                                <p className="text-[10px] text-slate-500 uppercase tracking-wider">Zugriff anfordern</p>
                            </div>
                            <i className="fa-solid fa-chevron-right text-slate-600 group-hover:text-slate-400 text-xs"></i>
                        </button>
                        <button
                        ...
                        >
                            ...
                            <div className="min-w-0 flex-1">
                                <p className="text-sm font-bold text-white leading-tight">Meine Bewerbungen</p>
                                <p className="text-[10px] text-slate-500 uppercase tracking-wider">Verfolgen du den Status</p>
                            </div>
                            <i className="fa-solid fa-chevron-right text-slate-600 group-hover:text-slate-400 text-xs"></i>
                        </button>
                    </div>
