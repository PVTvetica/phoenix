            ...
            <div className="flex justify-between items-center">
                <div>
                    <h2 className="text-xl font-black text-white flex items-center gap-3 uppercase tracking-tight">
                        <i className="fa-solid fa-person-military-rifle text-emerald-300"></i>Betriebsprotokoll</h2>
                    <p className="text-slate-400 text-sm mt-1">Einsätze und Übungen, an denen du teilgenommen hast.</p>
                </div>
            </div>
            <div className="bg-slate-900/60 backdrop-blur-md rounded-xl border border-slate-700/50 overflow-hidden">
                {myOps.length > 0 ? (
                    <table className="w-full text-left">
                        <thead>
                            <tr className="bg-white/5 border-b border-white/5 text-slate-500 text-[10px] uppercase tracking-widest font-black">
                                <th className="px-5 py-3">Betrieb</th>
                    ...
                    <EmptyState
                        ...
                        accent="emerald"
                        heading="Keine Einsatzhistorie"
                        description="Einsätze, an denen du teilnimmst, erscheinen hier."
                        compact
                    />
                )}
            </div>
