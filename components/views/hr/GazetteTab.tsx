            ...
            <div className="flex justify-between items-center">
                <div>
                    <h2 className="text-xl font-black text-white flex items-center gap-3 uppercase tracking-tight">
                        <i className="fa-solid fa-newspaper text-emerald-300"></i>Stellenanzeiger</h2>
            ...
            {openJobs.length > 0 ? (
                    ...
                    {openJobs.map(job => (
                        <div key={job.id} className="relative bg-slate-900/80 backdrop-blur-md border border-slate-700/50 rounded-xl p-5 pl-6 hover:border-emerald-500/30 hover:shadow-lg hover:shadow-emerald-900/20 hover:-translate-y-0.5 transition-all duration-300 group">
                            ...
                            <div className="flex flex-col md:flex-row justify-between items-start gap-4 mb-4">
                                ...
                                >
                                    <i className="fa-solid fa-pen-to-square"></i>Bewerben du sich jetzt</button>
                            </div>
                ...
                <div className="rounded-xl border border-dashed border-slate-700 bg-slate-900/30">
                    <EmptyState
                        icon="fa-newspaper"
                        accent="emerald"
                        heading="Keine offenen Stellen"
                        description="Schau später wieder vorbei — neue Chancen werden gepostet, wenn das Command Bedarf meldet."
                    />
                </div>
            )}
        </div>
