        ...
        <div className="space-y-6 animate-fade-in flex flex-col h-full">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 shrink-0">
                <div>
                    <h2 className="text-xl font-black text-white flex items-center gap-3 uppercase tracking-tight">
                        <i className="fa-solid fa-calendar-check text-emerald-300"></i>Interviews verwalten</h2>
            ...
            <div className="bg-slate-900/60 backdrop-blur-md rounded-xl border border-slate-700/50 overflow-hidden flex flex-col h-[600px]">
                <div className="hidden md:flex bg-white/5 border-b border-white/5 text-slate-500 text-[10px] uppercase tracking-widest font-black">
                    ...
                    <div className="p-4 flex-1">Thema</div>
                    <div className="p-4 flex-1">Protokoll</div>
                    <div className="p-4 flex-1">Interviewer</div>
                    <div className="p-4 w-40">Datum</div>
                    <div className="p-4 w-36 text-right">Aktionen</div>
                </div>
                ...
                <div className="flex-1 relative">
                    {allInterviews.length > 0 ? (
                        ...
                        <div className="flex items-center justify-center h-full text-slate-500 italic">Keine Interviews gefunden.</div>
                    )}
                </div>
            </div>
        </div>
