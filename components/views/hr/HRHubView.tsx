    ...
    const navGroups = useMemo(() => {
        ...
        const groups: NavGroup[] = [
            ...
            },
            {
                ...
                items: [
                    ...
                    { id: 'my-conduct' as HRTab, label: 'Verhaltensprotokoll', icon: 'fa-solid fa-gavel' },
                    { id: 'my-commendations' as HRTab, label: 'Belobigungen', icon: 'fa-solid fa-medal' },
                    { id: 'my-certifications' as HRTab, label: 'Zertifizierungen', icon: 'fa-solid fa-certificate' },
                ]
            }
        ];
        ...
        if (canRecruit || canManageJobs || canAdminHR) {
            ...
            if (canRecruit || canAdminHR) {
                hrItems.push({ id: 'case-management' as HRTab, label: 'Fallmanagement', icon: 'fa-solid fa-folder-tree', badge: heroStats.openCases > 0 ? heroStats.openCases : undefined });
                ...
                hrItems.push({ id: 'probation' as HRTab, label: 'Bewährungs-Tracker', icon: 'fa-solid fa-hourglass-half', badge: heroStats.probationTracked > 0 ? heroStats.probationTracked : undefined });

                hrItems.push({ id: 'my-interviews' as HRTab, label: 'Meine Interviews', icon: 'fa-solid fa-clipboard-user' });
                hrItems.push({ id: 'manage-interviews' as HRTab, label: 'Interviews verwalten', icon: 'fa-solid fa-calendar-check', badge: heroStats.pendingInterviews > 0 ? heroStats.pendingInterviews : undefined });
            }
