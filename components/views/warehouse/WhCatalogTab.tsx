                    ...
                    <table className="w-full text-left text-sm">
                        ...
                        <tbody className="divide-y divide-white/5">
                            ...
                            {filtered.length === 0 && !debouncedSearch && catalog.length === 0 && (
                                <tr><td colSpan={6} className="px-3 py-4 text-center text-xs text-slate-500 italic">Keine organisationsspezifischen Waren.</td></tr>
                            )}
                            {filtered.map((c) => (
                                    ...
                                    <td className="px-3 py-2 text-right">
                                        {canAdmin && (
                                            <button onClick={() => onEdit(c)}
                                                className="text-[10px] font-bold uppercase tracking-widest text-cyan-300 hover:text-cyan-200">Bearbeiten →</button>
                                        )}
                                    </td>
                                </tr>
                            ))}
                            ...
                            <table className="w-full text-left text-sm">
                                <tbody className="divide-y divide-white/5">
                                    ...
                                    {!platformLoading && !platformError && platformResults.length === 0 && (
                                        <tr><td colSpan={6} className="px-3 py-4 text-center text-xs text-slate-500 italic">Keine Plattformübereinstimmungen.</td></tr>
                                    )}
