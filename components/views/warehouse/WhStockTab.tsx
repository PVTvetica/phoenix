...
export default function WhStockTab({ locations, canManage, canRequest, canAdmin, onAdjust, onTransfer, onDelete, onRequest, onEditCommodity, onCreateStock, refreshKey }: Props) {
    ...
    const load = useCallback(async () => {
        ...
        try {
            ...
            if (seq !== requestSeq.current) return;
            addToast("Das Laden des Lagerbestands ist fehlgeschlagen", <i className="fa-solid fa-xmark" />, 'bg-red-500/10 text-red-400 border-red-500/50', { description: err?.message });
        } finally {
    ...
    const handleStartCsvExport = useCallback(async () => {
        ...
        try {
            ...
            addToast("Lagerbestand exportiert", <i className="fa-solid fa-check" />,
                                            ...
                                            <div className="flex-1 p-4 flex flex-col min-w-0">
                                                    ...
                                                    {reserved && (() => {
                                                        ...
                                                        return (
                                                            <div title={tooltip}>
                                                                ...
                                                                <div className="text-[10px] font-mono uppercase tracking-widest text-slate-500">Reserviert</div>
                                                            </div>
                                                        );
                                                    })()}
                                                </div>
                                                ...
                                                <div className="flex items-center gap-3 pt-3 mt-3 border-t border-white/5 flex-wrap">
                                                    ...
                                                    {canManage && (
                                                        ...
                                                        >
                                                            <i className="fa-solid fa-arrow-right-arrow-left mr-1" />Überweisen</button>
                                                    )}
                                                    {canAdmin && s.catalog && (
                                                        <button
                                                        ...
                                                        >
                                                            <i className="fa-solid fa-pen mr-1" />Ware bearbeiten</button>
                                                    )}
                                                    {canManage && (
                                                        <button
                                                            onClick={() => onDelete(s)}
                                                        ...
                                                        >
                                                            <i className="fa-solid fa-trash mr-1" />Löschen</button>
                                                    )}
                                                    <div className="flex-1" />
                                                    {canRequest && (
                                                        <button
