...
<p>Wir bieten folgende Leistungskategorien an:</p>
<ul>
<li><strong>Sicherheit:</strong> escort, overwatch, deterrence, patrol, asset protection</li>
<li><strong>Rettung:</strong> personnel recovery, medical support, extraction from hazardous environments</li>
<li><strong>Logistik:</strong> cargo transport, delivery, supply chain assistance, lawful salvage recovery</li>
</ul>
<p>Alle Operationen werden durchgeführt<strong>in-game only</strong> within the <strong>LIVE</strong> PU environment.</p>

<h2>2. Availability and Response</h2>
<p>Wir arbeiten auf einer<strong>on-duty personnel model</strong>. Response times may vary based on member availability.</p>
                ...
                <div className="relative px-4 sm:px-8 pt-10 pb-8">
                    <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
                        <div className="min-w-0">
                            ...
                            <h1 className="mt-3 text-3xl sm:text-4xl font-black text-white tracking-tight leading-tight">Nutzungsbedingungen</h1>
            ...
            <div className="flex-1 overflow-y-auto p-4 sm:p-6 lg:p-8 max-w-4xl mx-auto w-full">
                <div className="bg-slate-900/80 backdrop-blur-md border border-slate-700/50 rounded-xl p-6 md:p-10 shadow-lg">
                    <div className="text-center mb-8 border-b border-white/5 pb-6">
                        ...
                        <p className="text-sky-300 font-black uppercase tracking-[0.2em] text-[10px] mt-2">Nutzungsbedingungenprotokoll</p>
                    </div>
