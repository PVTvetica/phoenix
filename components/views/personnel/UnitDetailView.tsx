            ...
            <div className="h-full flex flex-col p-4 sm:p-6 animate-fade-in">
                ...
                <div className="flex-1 flex items-center justify-center">
                    <EmptyState
                        ...
                        accent="slate"
                        heading="Einheit nicht gefunden"
                        description="Diese Einheit wurde gelöscht oder du hast keinen Zugriff."
                    />
                </div>
            </div>
        );
            ...
            <div className="h-full flex flex-col p-4 sm:p-6 animate-fade-in">
                ...
                <div className="flex-1 flex items-center justify-center">
                    <div className="max-w-md w-full text-center bg-slate-900/40 border border-amber-500/20 rounded-xl p-8 space-y-4">
                        ...
                        >
                            <i className="fa-solid fa-arrow-left mr-2"></i>Zurück zum Organigramm</button>
                    </div>
                </div>
            </div>
        );
...
const BackButton: React.FC<{ onBack: () => void }> = ({ onBack }) => (
    ...
    >
        <i className="fa-solid fa-arrow-left"></i>Zurück zum Organigramm</button>
);
