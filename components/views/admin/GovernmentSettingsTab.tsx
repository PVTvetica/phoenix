...
const GovernmentSettingsTab: React.FC = () => {
    ...
    const toggleFeature = async () => {
        ...
        try {
            ...
            addToast("Einstellungen aktualisiert", <i className="fa-solid fa-check" />, 'bg-emerald-500/10 text-emerald-400 border-emerald-500/50', { description: `Government feature ${newEnabled ? 'enabled' : 'disabled'}.` });
        } catch (err: any) {
            setEnabled(!newEnabled);
            addToast("Aktualisierung fehlgeschlagen", <i className="fa-solid fa-circle-exclamation" />, 'bg-red-500/10 text-red-400 border-red-500/50', { description: err.message || 'Failed to update settings.' });
        } finally {
            setIsSaving(false);
        }
    };
    ...
    const applyTemplate = async (templateType: string) => {
        ...
        try {
            ...
            addToast("Vorlage angewendet", <i className="fa-solid fa-check" />, 'bg-emerald-500/10 text-emerald-400 border-emerald-500/50', { description: 'Regierungsstruktur wurde aktualisiert.' });
            await refreshGovernment();
        } catch (err: any) {
            addToast("Vorlage fehlgeschlagen", <i className="fa-solid fa-circle-exclamation" />, 'bg-red-500/10 text-red-400 border-red-500/50', { description: err.message || 'Failed to apply template.' });
        } finally {
            setIsLoading(false);
        }
    };
    ...
    const saveGovernmentIdentity = async () => {
        ...
        try {
            ...
            addToast("Identität gespeichert", <i className="fa-solid fa-check" />, 'bg-emerald-500/10 text-emerald-400 border-emerald-500/50', { description: 'Regierungsidentität aktualisiert.' });
            await refreshGovernment();
        } catch (err: any) {
            addToast("Speichern fehlgeschlagen", <i className="fa-solid fa-circle-exclamation" />, 'bg-red-500/10 text-red-400 border-red-500/50', { description: err.message || 'Failed to update government identity.' });
        } finally {
            setIsSaving(false);
        }
    };
    ...
    const saveConstitution = async (json: any) => {
        try {
            ...
            addToast("Verfassung gerettet", <i className="fa-solid fa-check" />, 'bg-emerald-500/10 text-emerald-400 border-emerald-500/50', { description: 'Verfassung aktualisiert.' });
            await refreshGovernment();
        } catch (err: any) {
            addToast("Speichern fehlgeschlagen", <i className="fa-solid fa-circle-exclamation" />, 'bg-red-500/10 text-red-400 border-red-500/50', { description: err.message || 'Failed to update constitution.' });
        }
    };
    ...
    const appointHolder = async () => {
        ...
        try {
            ...
            addToast("Termin bestätigt", <i className="fa-solid fa-check" />, 'bg-emerald-500/10 text-emerald-400 border-emerald-500/50', { description: 'Positionsinhaber erfolgreich ernannt.' });
            await refreshGovernment();
        } catch (err: any) {
            addToast("Termin fehlgeschlagen", <i className="fa-solid fa-circle-exclamation" />, 'bg-red-500/10 text-red-400 border-red-500/50', { description: err.message || 'Failed to appoint holder.' });
        } finally {
            setIsLoading(false);
        }
    };
    ...
    const removeHolder = async (holderId: number, holderName: string) => {
        ...
        try {
            ...
            addToast("Halter entfernt", <i className="fa-solid fa-check" />, 'bg-emerald-500/10 text-emerald-400 border-emerald-500/50', { description: `${holderName} removed from position.` });
            await refreshGovernment();
        } catch (err: any) {
            addToast("Entfernen fehlgeschlagen", <i className="fa-solid fa-circle-exclamation" />, 'bg-red-500/10 text-red-400 border-red-500/50', { description: err.message || 'Failed to remove holder.' });
        }
    };
    ...
    const saveBranch = async () => {
        ...
        try {
            ...
            addToast("Zweig gespeichert", <i className="fa-solid fa-check" />, 'bg-emerald-500/10 text-emerald-400 border-emerald-500/50', { description: `Branch ${editingBranch ? 'updated' : 'created'}.` });
            await refreshGovernment();
        } catch (err: any) {
            addToast("Speichern fehlgeschlagen", <i className="fa-solid fa-circle-exclamation" />, 'bg-red-500/10 text-red-400 border-red-500/50', { description: err.message || 'Failed to save branch.' });
        } finally {
            setIsLoading(false);
        }
    };
    ...
    const deleteBranch = async (branch: GovernmentBranch) => {
        ...
        try {
            ...
            addToast("Zweig gelöscht", <i className="fa-solid fa-trash" />, 'bg-slate-500/10 text-slate-300 border-slate-500/40', { description: `Branch "${branch.name}" removed.` });
            await refreshGovernment();
        } catch (err: any) {
            addToast("Löschen fehlgeschlagen", <i className="fa-solid fa-circle-exclamation" />, 'bg-red-500/10 text-red-400 border-red-500/50', { description: err.message || 'Failed to delete branch.' });
        }
    };
    ...
    const savePosition = async () => {
        ...
        try {
            ...
            addToast("Position gespeichert", <i className="fa-solid fa-check" />, 'bg-emerald-500/10 text-emerald-400 border-emerald-500/50', { description: `Position ${editingPosition ? 'updated' : 'created'}.` });
            await refreshGovernment();
        } catch (err: any) {
            addToast("Speichern fehlgeschlagen", <i className="fa-solid fa-circle-exclamation" />, 'bg-red-500/10 text-red-400 border-red-500/50', { description: err.message || 'Failed to save position.' });
        } finally {
            setIsLoading(false);
        }
    };
    ...
    const deletePosition = async (position: GovernmentPosition) => {
        ...
        try {
            ...
            addToast("Position gelöscht", <i className="fa-solid fa-trash" />, 'bg-slate-500/10 text-slate-300 border-slate-500/40', { description: `Position "${position.name}" removed.` });
            await refreshGovernment();
        } catch (err: any) {
            addToast("Löschen fehlgeschlagen", <i className="fa-solid fa-circle-exclamation" />, 'bg-red-500/10 text-red-400 border-red-500/50', { description: err.message || 'Failed to delete position.' });
        }
    };
    ...
    const moveBranch = async (branchId: number, direction: -1 | 1) => {
        ...
        try {
            ...
            addToast("Nachbestellung fehlgeschlagen", <i className="fa-solid fa-circle-exclamation" />, 'bg-red-500/10 text-red-400 border-red-500/50', { description: err.message || 'Failed to reorder branches.' });
        }
    };
    ...
    const movePosition = async (positionId: number, branchId: number, direction: -1 | 1) => {
        ...
        try {
            ...
            addToast("Nachbestellung fehlgeschlagen", <i className="fa-solid fa-circle-exclamation" />, 'bg-red-500/10 text-red-400 border-red-500/50', { description: err.message || 'Failed to reorder positions.' });
        }
    };
    ...
    return (
        <div className="p-4 md:p-8 space-y-6 animate-fade-in">
            <TabPageHeader
                ...
                accent="indigo"
                subtitle="Konfiguriere Zweige, Positionen, Wahlen und Gesetzgebung."
            />
            ...
            {enabled ? (
                <div className="flex items-center gap-3 p-3 bg-indigo-500/5 border border-indigo-500/20 rounded-lg text-xs text-indigo-200/80">
                    ...
                    <span>Regierung ist aktiv. Funktion umschalten unter<span className="text-indigo-300 font-semibold">Admin → Optionale Funktionen</span>.</span>
                </div>
            ) : (
                <div className="p-6 bg-indigo-500/5 border border-indigo-500/20 rounded-xl text-center">
                    ...
                    <h3 className="text-lg font-bold text-white mb-1">Regierungsfunktion deaktiviert</h3>
                    <p className="text-sm text-slate-400 mb-4 max-w-md mx-auto leading-relaxed">Aktivieren du die Regierung<span className="text-indigo-300 font-semibold">Admin → Optionale Funktionen</span> to configure branches, positions, elections, and legislation.
                    </p>
                </div>
            )}
            ...
            {enabled && (
                <>
                    ...
                    <div className="bg-slate-800/30 border border-slate-700/50 rounded-lg p-4">
                        <h4 className="text-sm font-semibold text-white mb-2">Schnelleinrichtungsvorlagen</h4>
                        ...
                        <div className="flex flex-wrap gap-2">
                            {[
                                { type: 'military_junta', label: 'Militärjunta', icon: 'fa-solid fa-helmet-safety' },
                                { type: 'corporate_board', label: 'Unternehmensvorstand', icon: 'fa-solid fa-building' },
                                { type: 'democratic_republic', label: 'Demokratische Republik', icon: 'fa-solid fa-landmark-dome' },
                                { type: 'constitutional_monarchy', label: 'Konstitutionelle Monarchie', icon: 'fa-solid fa-crown' },
                                { type: 'westminster', label: 'Westminster', icon: 'fa-solid fa-landmark' },
                                { type: 'technocracy', label: 'Technokratie', icon: 'fa-solid fa-microchip' },
                                { type: 'pirate_code', label: 'Piratenkodex', icon: 'fa-solid fa-skull-crossbones' },
                            ].map(t => (
                                <button
                                    key={t.type}
                    ...
                    {governmentConfig && (
                        <div className="bg-slate-800/30 border border-slate-700/50 rounded-lg p-4">
                            <div className="flex items-center justify-between mb-3">
                                <h4 className="text-sm font-semibold text-white">Regierungsidentität</h4>
                                {!isEditingIdentity ? (
                                    <button
                                        onClick={() => setIsEditingIdentity(true)}
                                        className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium text-slate-300 bg-slate-700/50 border border-slate-600/50 rounded-md hover:bg-slate-700 transition-colors"
                                    >
                                        <i className="fa-solid fa-pen text-xs"></i>Bearbeiten</button>
                                ) : (
                            ...
                            {isEditingIdentity ? (
                                <div className="space-y-3">
                                    <div>
                                        <label className="text-xs text-slate-400 mb-1 block">Name der Regierung</label>
                                        <input
                                            value={govName}
                                    ...
                                    <div>
                                        <label className="text-xs text-slate-400 mb-1 block">Regierungstyp</label>
                                        <select
                                            value={govType}
                                            onChange={e => setGovType(e.target.value)}
                                            className="w-full bg-slate-800 border border-slate-700 rounded-md px-3 py-2 text-sm text-white"
                                        >
                                            <option value="military_junta">Militärjunta</option>
                                            <option value="corporate_board">Unternehmensvorstand</option>
                                            <option value="democratic_republic">Demokratische Republik</option>
                                            <option value="constitutional_monarchy">Konstitutionelle Monarchie</option>
                                            <option value="westminster">Westminster</option>
                                            <option value="technocracy">Technokratie</option>
                                            <option value="pirate_code">Piratenkodex</option>
                                            <option value="custom">Brauch</option>
                                        </select>
                                    </div>
                                    <div>
                    ...
                    <div className="bg-slate-800/30 border border-slate-700/50 rounded-lg p-4">
                        <div className="flex items-center justify-between mb-3">
                            <h4 className="text-sm font-semibold text-white flex items-center gap-2">
                                <i className="fa-solid fa-scroll text-amber-400 text-xs"></i>Verfassung</h4>
                    ...
                    <div>
                        <div className="flex items-center justify-between mb-3">
                            <h4 className="text-sm font-semibold text-white">Filialen & Positionen</h4>
                            <div className="flex items-center gap-2">
                                <button
                                ...
                                >
                                    <i className="fa-solid fa-plus"></i>Unabhängige Position hinzufügen</button>
                                <button
                                ...
                                >
                                    <i className="fa-solid fa-plus"></i>Zweig hinzufügen</button>
                            </div>
                        </div>
                                ...
                                <div className="bg-slate-800/40 border border-slate-700/50 rounded-lg overflow-hidden mb-3">
                                    <div className="flex items-center justify-between px-4 py-2.5 bg-slate-800/60">
                                        <div className="flex items-center gap-2">
                                            ...
                                            <span className="text-sm font-medium text-white">Unabhängige Positionen</span>
                                            <span className="text-[10px] px-1.5 py-0.5 rounded-sm bg-slate-700 text-slate-400">Keine Filiale</span>
                                        </div>
                                    </div>
                                    ...
                                    return (
                                        <div key={branch.id} className="bg-slate-800/40 border border-slate-700/50 rounded-lg overflow-hidden">
                                            ...
                                            {branchPositions.length > 0 ? (
                                                ...
                                                <p className="text-xs text-slate-500 text-center py-3">Keine Stellen in dieser Branche</p>
                                            )}
                                        </div>
                                    );
                                })}
            ...
            <WindowFrame
                ...
                subtitle="Regierungskonfiguration"
            ...
            >
                <div className="flex flex-col h-full">
                    <div className="flex-1 overflow-y-auto p-6 space-y-3">
                        ...
                        <div>
                            <label className="text-xs text-slate-400 mb-1 block">Symbol (FontAwesome-Klasse)</label>
                    ...
                    <div className="border-t border-white/10 bg-slate-950/50 px-6 py-4 flex justify-end gap-2 shrink-0">
                        <button onClick={() => setShowBranchForm(false)} className="px-3 py-1.5 text-xs text-slate-400 hover:text-white">Abbrechen</button>
                        <button onClick={saveBranch} disabled={isLoading || !branchName.trim()} className="px-4 py-1.5 text-xs font-medium bg-indigo-600 hover:bg-indigo-500 text-white rounded-md disabled:opacity-40">Speichern</button>
                    </div>
                </div>
            </WindowFrame>
            ...
            >
                <div className="flex flex-col h-full">
                    <div className="flex-1 overflow-y-auto p-6 space-y-3">
                        <div>
                            <label className="text-xs text-slate-400 mb-1 block">Zweig</label>
                            <select
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            <div>
                                <label className="text-xs text-slate-400 mb-1 block">Füllmethode</label>
                            ...
                            <div>
                                <label className="text-xs text-slate-400 mb-1 block">Max-Inhaber</label>
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            <div>
                                <label className="text-xs text-slate-400 mb-1 block">Laufzeit (Tage)</label>
                            ...
                            <div>
                                <label className="text-xs text-slate-400 mb-1 block">Symbol (FontAwesome)</label>
                        ...
                        <div className="border-t border-slate-700/50 pt-3">
                            <h4 className="text-xs font-semibold text-slate-300 mb-2">Gesetzgebungsbefugnisse</h4>
                            <div className="space-y-2">
                                <label className="flex items-center gap-2 text-xs text-slate-300 cursor-pointer">
                                    <input type="checkbox" checked={posCanPropose} onChange={e => setPosCanPropose(e.target.checked)} className="rounded-sm border-slate-600" />Kann Gesetze vorschlagen</label>
                                <label className="flex items-center gap-2 text-xs text-slate-300 cursor-pointer">
                                    <input type="checkbox" checked={posCanVote} onChange={e => setPosCanVote(e.target.checked)} className="rounded-sm border-slate-600" />Kann über Gesetze abstimmen</label>
                                <label className="flex items-center gap-2 text-xs text-slate-300 cursor-pointer">
                                    <input type="checkbox" checked={posCanVeto} onChange={e => setPosCanVeto(e.target.checked)} className="rounded-sm border-slate-600" />Hat ein Vetorecht</label>
                                <label className="flex items-center gap-2 text-xs text-slate-300 cursor-pointer">
                                    <input type="checkbox" checked={posCanCallElections} onChange={e => setPosCanCallElections(e.target.checked)} className="rounded-sm border-slate-600" />Kann Wahlen ausrufen</label>
                                <label className="flex items-center gap-2 text-xs text-slate-300 cursor-pointer">
                                    <input type="checkbox" checked={posCanIssueOrders} onChange={e => setPosCanIssueOrders(e.target.checked)} className="rounded-sm border-slate-600" />Kann Durchführungsverordnungen erlassen</label>
                            </div>
                        </div>
                    </div>
                    <div className="border-t border-white/10 bg-slate-950/50 px-6 py-4 flex justify-end gap-2 shrink-0">
                        <button onClick={() => setShowPositionForm(false)} className="px-3 py-1.5 text-xs text-slate-400 hover:text-white">Abbrechen</button>
                        <button onClick={savePosition} disabled={isLoading || !posName.trim()} className="px-4 py-1.5 text-xs font-medium bg-indigo-600 hover:bg-indigo-500 text-white rounded-md disabled:opacity-40">Speichern</button>
                    </div>
                </div>
            </WindowFrame>
            <WindowFrame
            ...
            >
                <div className="flex flex-col h-full">
                    <div className="flex-1 overflow-y-auto p-6 space-y-3">
                        <div>
                            <label className="text-xs text-slate-400 mb-1 block">Mitglieder suchen</label>
                            <input
                                value={appointSearch}
                        ...
                        <div className="max-h-72 overflow-y-auto space-y-0.5 bg-slate-800/50 rounded-md border border-slate-700/50">
                            {filteredAppointUsers.length === 0 ? (
                                <p className="text-xs text-slate-500 text-center py-4">Keine Mitglieder gefunden</p>
                            ) : (
                                filteredAppointUsers.map(user => {
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            {alreadyHolds && <span className="text-[10px] text-slate-500">Hält schon</span>}
                    ...
                    <div className="border-t border-white/10 bg-slate-950/50 px-6 py-4 flex justify-end gap-2 shrink-0">
                        <button onClick={() => setShowAppointModal(false)} className="px-3 py-1.5 text-xs text-slate-400 hover:text-white">Abbrechen</button>
                        <button
