    ...
    return (
        <div className="p-4 md:p-8 space-y-6 animate-fade-in">
            <TabPageHeader
                ...
                accent="cyan"
                subtitle="Externe Intel-Feeds, API-Zugriff und Datenbanksync verwalten."
            />
            ...
            <div className="bg-slate-900/40 rounded-xl border border-slate-700/50 overflow-hidden">
                <div className="px-6 py-4 bg-slate-800/50 border-b border-slate-700/50">
                    <h3 className="text-sm font-bold text-white uppercase tracking-wider flex items-center">
                        <i className="fa-solid fa-shield-halved mr-3 text-amber-400"></i>Richtlinie zum Teilen ausgehender Feeds</h3>
                </div>
                <div className="p-6">
                    ...
                    <div className="flex flex-col md:flex-row md:items-center gap-2 md:gap-4">
                        <label className="text-xs font-bold text-slate-400 uppercase tracking-wider whitespace-nowrap">Maximales teilbares Level</label>
                        <select
                        ...
                        >
                            {securityClearances.length > 0 ? (
                                ...
                                <>
                                    <option value={0}>Stufe 0 – Nur nicht klassifiziert</option>
                                    <option value={1}>Stufe 1 – Eingeschränkt und darunter</option>
                                    <option value={2}>Stufe 2 – Vertraulich und unten</option>
                                    <option value={3}>Level 3 – Geheimnis und darunter</option>
                                    <option value={4}>Level 4 – Streng geheim und darunter</option>
                                </>
                            )}
                        </select>
            ...
            <div className="bg-slate-900/40 rounded-xl border border-slate-700/50 overflow-hidden">
                <div className="px-6 py-4 bg-slate-800/50 border-b border-slate-700/50 flex justify-between items-center">
                    <h3 className="text-sm font-bold text-white uppercase tracking-wider flex items-center">
                        <i className="fa-solid fa-key mr-3 text-emerald-400"></i>API Zugriffsverwaltung</h3>
                ...
                <div className="p-6">
                    ...
                    {justCreatedKey && (
                        <div className="bg-emerald-900/30 border border-emerald-500/50 p-4 rounded-lg mb-6 animate-fade-in">
                            ...
                            <p className="text-sm text-slate-300 mb-2">Schlüssel jetzt kopieren. Du kannst ihn später nicht mehr einsehen.</p>
                        ...
                        <table className="w-full text-left">
                            <thead>
                                <tr className="border-b border-slate-700 text-slate-400 text-sm">
                                    <th className="p-3">Etikett</th>
                                    <th className="p-3">Schlüsselpräfix</th>
                                    <th className="p-3">Erstellt</th>
                                    <th className="p-3">Zuletzt verwendet</th>
                            ...
                            <tbody className="divide-y divide-slate-800">
                                ...
                                {keys.length === 0 && (
                                    <tr>
                                        <td colSpan={5} className="p-4 text-center text-slate-500 italic">Keine aktiven API-Tasten.</td>
                                    </tr>
                                )}
                            </tbody>
                        </table>
                    ...
                    <div className="mt-6 bg-black/20 p-4 rounded-lg border border-slate-700/50">
                        <h3 className="text-white font-bold mb-2 text-xs uppercase tracking-wider">Dein Feed-Endpunkt</h3>
                        ...
                        <div className="px-5 py-4 border-b border-slate-700/50 flex items-center justify-between">
                            ...
                            {isOperationRunning ? (
                                <div className="flex items-center gap-2">
                                    ...
                                    <span className="text-xs text-slate-300 font-bold uppercase">Läuft</span>
                                </div>
                            ) : (
