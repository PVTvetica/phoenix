    ...
    return (
        <div className="p-4 md:p-8 space-y-6 animate-fade-in">
            <TabPageHeader
                ...
                accent="emerald"
                subtitle="Schalte optionale Module für deine Organisation ein oder aus. Deaktivierte Module sind für alle Mitglieder unsichtbar und Backend-Aktionen werden abgelehnt."
            />
                        ...
                        <div className="flex items-start gap-4 p-5">
                            ...
                            <div className="flex-1">
                                <div className="flex items-start justify-between gap-4">
                                    <div>
                                        <h3 className="font-semibold text-white">Regierung</h3>
                                        <p className="text-xs text-slate-400 mt-1 leading-relaxed">
                                            Let your organization establish branches, positions, elections, and legislation. Full configuration &mdash; templates, constitution, seats &mdash; is managed from the <span className="text-indigo-300 font-semibold">Regierung</span> tab when enabled.
                                        </p>
                                    </div>
                                    <Toggle
                    ...
                    <div className="bg-slate-800/50 rounded-lg border border-slate-700 overflow-hidden">
                        <div className="flex items-start gap-4 p-5">
                            ...
                            <div className="flex-1">
                                <div className="flex items-start justify-between gap-4">
                                    <div>
                                        <h3 className="font-semibold text-white">Finanzen</h3>
                                        <p className="text-xs text-slate-400 mt-1 leading-relaxed">
                    ...
                    <div className="bg-slate-800/50 rounded-lg border border-slate-700 overflow-hidden">
                        <div className="flex items-start gap-4 p-5">
                            ...
                            <div className="flex-1">
                                <div className="flex items-start justify-between gap-4">
                                    <div>
                                        <h3 className="font-semibold text-white">Quartiermeister</h3>
                                        <p className="text-xs text-slate-400 mt-1 leading-relaxed">
                    ...
                    <div className="bg-slate-800/50 rounded-lg border border-slate-700 overflow-hidden">
                        <div className="flex items-start gap-4 p-5">
                            ...
                            <div className="flex-1">
                                <div className="flex items-start justify-between gap-4">
                                    <div>
                                        <h3 className="font-semibold text-white">Lager</h3>
                                        <p className="text-xs text-slate-400 mt-1 leading-relaxed">
                    ...
                    <div className="bg-slate-800/50 rounded-lg border border-slate-700 overflow-hidden">
                        <div className="flex items-start gap-4 p-5">
                            ...
                            <div className="flex-1">
                                <div className="flex items-start justify-between gap-4">
                                    <div>
                                        <h3 className="font-semibold text-white">Bestenliste</h3>
                                        <p className="text-xs text-slate-400 mt-1 leading-relaxed">
                    ...
                    <div className="bg-slate-800/50 rounded-lg border border-slate-700 overflow-hidden">
                        <div className="flex items-start gap-4 p-5">
                            ...
                            <div className="flex-1">
                                <div className="flex items-start justify-between gap-4">
                                    <div>
                                        <h3 className="font-semibold text-white">Externe Tools</h3>
                                        <p className="text-xs text-slate-400 mt-1 leading-relaxed">
