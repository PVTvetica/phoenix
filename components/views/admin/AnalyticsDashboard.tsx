            ...
            <SectionPanel
                ...
                actions={
                    <div className="hidden md:flex flex-wrap gap-3 text-[10px] font-black uppercase tracking-widest">
                        <span className="flex items-center gap-1.5 text-emerald-300"><span className="w-2 h-2 rounded-full bg-emerald-500"></span>Erfolg</span>
                        <span className="flex items-center gap-1.5 text-blue-300"><span className="w-2 h-2 rounded-full bg-blue-500"></span>Aktiv</span>
                        <span className="flex items-center gap-1.5 text-amber-300"><span className="w-2 h-2 rounded-full bg-amber-500"></span>Abgesagt</span>
                        <span className="flex items-center gap-1.5 text-orange-300"><span className="w-2 h-2 rounded-full bg-orange-500"></span>Abgebrochen</span>
                        <span className="flex items-center gap-1.5 text-red-300"><span className="w-2 h-2 rounded-full bg-red-500"></span>Fehlgeschlagen</span>
                    </div>
                }
            >
