        ...
        <div className="h-full flex flex-col p-4 md:p-8 animate-fade-in">
            <div className="shrink-0">
                <TabPageHeader
                    ...
                    accent="emerald"
                    subtitle={<>Gesamtpersonal:<span className="font-mono text-slate-300 font-bold">{members.length}</span></>}
            ...
            <div className="mt-4 flex flex-wrap items-center gap-2 shrink-0">
                ...
                {(unitFilter.size > 0 || rankFilter.size > 0 || searchTerm.trim().length > 0) && (
                    <>
                        ...
                        >
                            <i className="fa-solid fa-rotate-left text-[10px]"></i>Filter zurücksetzen</button>
                ...
                {rosterMode === 'flat' ? (
                    <div className="flex items-center bg-slate-800/80 p-4 border-b border-slate-700 shrink-0">
                        ...
                        <div className="w-48 hidden md:block">
                            <SortableColumnHeader label="Rang" sortKey="rank" activeKey={flatSortKey} sortDir={flatSortDir} onSort={requestFlatSort} />
                        </div>
                        ...
                        <div className="w-44 hidden xl:block">
                            <SortableColumnHeader label="Einheit" sortKey="unit" activeKey={flatSortKey} sortDir={flatSortDir} onSort={requestFlatSort} />
                        </div>
                    ...
                    <div className="flex bg-slate-800/80 p-4 border-b border-slate-700 text-xs font-black text-slate-500 uppercase tracking-widest shrink-0">
                        ...
                        <div className="w-48 hidden md:block">Rang</div>
                ...
                {isLoading ? (
                    <div className="absolute inset-0 flex items-center justify-center z-10 bg-slate-900/50 backdrop-blur-xs">
                        <div className="flex flex-col items-center">
                            ...
                            <span className="text-xs font-bold text-slate-300 uppercase tracking-widest">Dienstplan wird geladen…</span>
                        </div>
                    </div>
                ) : (
                    <div id={scrollId} className="flex-1 relative overflow-y-auto custom-scrollbar">
                        {flattenedRoster.length > 0 ? (
                            ...
                            <div className="absolute inset-0 flex items-center justify-center text-slate-500 italic">Kein Personal gefunden.</div>
                        )}
                    </div>
                )}
            </div>
