...
const AIConfigTab: React.FC = () => {
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            console.error(err);
            addToast("Speichern fehlgeschlagen", <i className="fa-solid fa-xmark"></i>, "bg-red-500/10 text-red-400 border-red-500/50", { description: "KI-Einstellungen konnten nicht gespeichert werden." });
        } finally {
            setIsSaving(false);
        }
    };
    ...
    return (
        <div className="p-4 md:p-8 space-y-6 animate-fade-in">
            <TabPageHeader
                ...
                accent="purple"
                subtitle="Konfiguriere die Integration mit Google Gemini für automatisierte Intel-Zusammenfassungen."
            />
            ...
            <SectionPanel title="Gemini Configuration" icon="fa-solid fa-robot">
                <div className="space-y-6 max-w-xl">
                    <div className="flex items-center justify-between p-4 bg-slate-800/50 rounded-lg border border-slate-700">
                        <div>
                            <h3 className="font-medium text-white">AI-Funktionen aktivieren</h3>
                    ...
                    <div>
                        <label className="block text-sm font-bold text-slate-300 mb-2 uppercase tracking-wider">Auswahl taktischer Modelle</label>
                        <select
                            value={config.model}
                        ...
                        >
                            <option value="gemini-2.5-flash">Gemini 2.5 Flash (empfohlen – schnell)</option>
                            <option value="gemini-2.5-flash-lite">Gemini 2.5 Flash Lite (höchstes Kontingent)</option>
                            <option value="gemini-2.5-pro">Gemini 2.5 Pro (Hohe Argumentation – niedrige Quote)</option>
                        </select>
