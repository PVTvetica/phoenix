...
const AdminTabFallback = () => (
    <div className="flex items-center justify-center h-64">
        <div className="text-center space-y-3">
            ...
            <p className="text-slate-400 text-xs font-mono uppercase tracking-widest">Lademodul</p>
        </div>
    </div>
);
...
const tabGroups = {
    ...
    "User Management": [
        { id: 'roster', label: 'Mitglieder', icon: 'fa-solid fa-users', permission: 'admin:view:roster' },
    ...
    "Organization": [
        ...
        { id: 'member_roles', label: 'Positionen', icon: 'fa-solid fa-briefcase', permission: 'hr:manage:positions' },
    ...
    "Governance": [
        { id: 'government', label: 'Regierung', icon: 'fa-solid fa-landmark', permission: 'gov:admin' },
    ],
    "Diplomacy": [
    ...
    "Catalogs": [
        { id: 'catalog_ships', label: 'Schiffskatalog', icon: 'fa-solid fa-rocket', permission: 'admin:config:catalog' },
        { id: 'catalog_items', label: 'Artikelkatalog', icon: 'fa-solid fa-box-open', permission: 'admin:config:catalog' },
        { id: 'catalog_commodities', label: 'Warenkatalog', icon: 'fa-solid fa-flask', permission: 'admin:config:catalog' },
        { id: 'catalog_locations', label: 'Standortkatalog', icon: 'fa-solid fa-globe', permission: 'admin:config:catalog' },
    ],
    "Maintenance": [
    ...
    return (
        <div className="h-full flex flex-col overflow-hidden animate-fade-in">
            <HeroShell
                ...
                chipAccent="slate"
                title="Admin Konsole"
                subtitle="Organisationskonfiguration, Nutzer, Integrationen und Wartung."
                stats={<>
                    <HeroStat icon="fa-users" label="Mitglieder" value={heroStats.members} accent="sky" />
                    <HeroStat icon="fa-tower-broadcast" label="Aktive Anfragen" value={heroStats.activeRequests} accent="amber" emphasize={heroStats.activeRequests > 0} />
                    <HeroStat icon="fa-folder-open" label="Open Cases" value={heroStats.openCases} accent="emerald" emphasize={heroStats.openCases > 0} />
                    <HeroStat icon="fa-bolt" label="Im Dienst" value={heroStats.dutyNow} accent="emerald" emphasize={heroStats.dutyNow > 0} />
                </>}
            />
