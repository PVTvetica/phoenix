        ...
        <div className="h-full flex flex-col p-4 md:p-8 animate-fade-in">
            <div className="shrink-0">
                <TabPageHeader
                    ...
                    accent="sky"
                    subtitle={<>Insgesamt registriert:<span className="font-mono text-slate-200 font-bold">{clientData.length}</span></>}
                    actions={
            ...
            <div className="@container/clients bg-slate-900/40 rounded-xl border border-slate-700/50 overflow-hidden flex-1 min-h-0 flex flex-col relative mt-6">
                ...
                <div className="flex bg-slate-800/80 p-4 border-b border-slate-700 text-xs font-black text-slate-500 uppercase tracking-widest shrink-0">
                    ...
                    <div className="flex-1">Kundenidentität</div>
                    <div className="w-48 hidden @3xl/clients:block">Beigetreten</div>
                    <div className="w-32 text-center hidden @2xl/clients:block">Anfragen</div>
                    <div className="w-32 text-right hidden @lg/clients:block">Ruf</div>
                ...
                {isLoading ? (
                    <div className="absolute inset-0 flex items-center justify-center z-10 bg-slate-900/50 backdrop-blur-xs">
                        <div className="flex flex-col items-center">
                            ...
                            <span className="text-xs font-bold text-slate-300 uppercase tracking-widest">Zugriff auf die Registrierung…</span>
                        </div>
                    </div>
                ) : (
                    <div id="admin-client-list" className="flex-1 relative overflow-y-auto custom-scrollbar">
                        {clientData.length > 0 ? (
                            ...
                            <div className="absolute inset-0 flex items-center justify-center text-slate-500 italic">Keine Clients gefunden.</div>
                        )}
                    </div>
                )}
            </div>
