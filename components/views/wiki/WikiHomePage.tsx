            ...
            <div className="max-w-4xl space-y-6 animate-fade-in">
                <div className="flex items-center justify-between pb-4 border-b border-slate-700/50">
                    <div className="flex items-center gap-3">
                        ...
                        <h1 className="text-2xl font-bold text-white flex items-center gap-3">
                            <i className="fa-solid fa-house-chimney text-sky-500" />Wiki Startseite bearbeiten</h1>
                    </div>
                </div>
                ...
                <div className="space-y-3 pt-4 border-t border-slate-700/50">
                    ...
                    {editFeaturedPages.length > 0 ? (
                        ...
                        <p className="text-xs text-slate-600 italic">Keine vorgestellten Artikel ausgewählt.</p>
                    )}
                    ...
                    {availableToFeature.length > 0 && (
                        <div className="flex items-center gap-2">
                            ...
                            >
                                <option value="">Wähle eine Seite aus, die du vorstellen möchten…</option>
                            ...
                            >
                                <i className="fa-solid fa-plus mr-1" />Hinzufügen</button>
                        </div>
                    )}
                ...
                <div className="space-y-3 pt-4 border-t border-slate-700/50">
                    ...
                    <label className="flex items-center gap-3 cursor-pointer p-3 rounded-lg bg-slate-800/40 border border-slate-700/40 hover:border-sky-500/30 transition-colors">
                        ...
                        />
                        <div>
                            <span className="text-xs font-bold text-white block">„Kürzlich aktualisiert“ ausblenden</span>
                            <span className="text-[10px] text-slate-500 block leading-tight mt-0.5">Aktuelle Änderungen nicht auf der Wiki-Startseite anzeigen.</span>
                        </div>
                    </label>
                </div>
            </div>
            ...
            <div className="flex items-center justify-between">
                ...
                {canEdit && (
                    ...
                    >
                        ...
                        <span className="hidden md:inline">Startseite bearbeiten</span>
                    </button>
                )}
            </div>
