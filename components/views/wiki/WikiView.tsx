        ...
        <div className="flex flex-col h-full animate-fade-in bg-slate-950">
            ...
            <div className="flex flex-1 min-h-0">
                ...
                <aside className="hidden md:flex md:w-64 lg:w-72 shrink-0 flex-col bg-slate-900/60 border-r border-slate-800">
                    ...
                    >
                        <i className="fa-solid fa-house text-[10px]" />Wiki Startseite</button>
                        ...
                        {isInitialLoading ? (
                            ...
                            <div className="space-y-4 max-w-4xl">
                                <div className="flex items-center gap-3 pb-4 border-b border-slate-700/50">
                                    ...
                                    <h1 className="text-xl md:text-2xl font-bold text-white">Neue Seite erstellen</h1>
                                </div>

                                <div>
                                    <label className="block text-[10px] font-black text-slate-400 uppercase tracking-[0.25em] mb-2">Seitentitel</label>
                                    <input
                                        type="text"
                                        value={newPageTitle}
            ...
            >
                <div className="px-2 pb-4 pt-2">
                    ...
                    {canCreate && (
                        ...
                        >
                            <i className="fa-solid fa-plus" />Neue Seite</button>
                    )}
                    {treeNode}
                </div>
            </BottomSheet>
