                ...
                <div className="flex items-center justify-between gap-3 pb-4 border-b border-slate-700/50">
                    <div className="flex items-center gap-3 flex-1 min-w-0">
                        ...
                        <div className="flex-1 min-w-0">
                            ...
                            />
                            <p className="text-[10px] text-slate-500 mt-1">Titel, Inhalt und Einstellungen werden zusammen gespeichert.</p>
                        </div>
                    </div>
                    <button
                ...
                {(canEdit || canDelete) && (
                    <div className="flex items-center gap-2 shrink-0">
                        {canEdit && (
                            ...
                            >
                                <i className="fa-solid fa-pen mr-1.5" />Bearbeiten</button>
                        )}
                        {canDelete && (
                            <button
                            ...
                            >
                                <i className={`fa-solid ${isDeleting ? 'fa-spinner fa-spin' : 'fa-trash'} mr-1.5`} />Löschen</button>
                        )}
                    </div>
                )}
            </header>
