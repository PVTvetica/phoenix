            ...
            <div className="flex-1 overflow-y-auto overflow-x-hidden custom-scrollbar p-4 sm:p-6 space-y-4">
                ...
                <div className="flex flex-col sm:flex-row gap-3 sm:items-center">
                    ...
                    <div className="flex gap-2">
                        ...
                        >
                            <i className="fa-solid fa-angles-down"></i>Expandieren</button>
                        <button
                            type="button"
                            onClick={collapseAll}
                            className="flex items-center gap-1.5 px-3 py-2 rounded-lg bg-slate-900/60 text-slate-300 border border-slate-700 hover:text-white hover:border-indigo-500/30 text-[10px] font-black uppercase tracking-wider transition-colors"
                        >
                            <i className="fa-solid fa-angles-up"></i>Zusammenbruch</button>
                    </div>
                </div>
                ...
                >
                    ...
                    <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-1.5 sm:gap-2 flex-wrap">
                            ...
                            {isRoot ? (
                                <span className={`text-[9px] font-black ${tier.text} ${tier.bg} border border-current/30 px-1.5 py-0.5 rounded-sm uppercase tracking-wider`}>Wurzel</span>
                            ) : (
                            ...
                            {isMember && (
                                <span className="text-[9px] font-bold text-emerald-300 bg-emerald-500/10 border border-emerald-500/30 px-1.5 py-0.5 rounded-sm uppercase tracking-wider">Deine Einheit</span>
                            )}
                            {restricted && (
                                <span className="text-[9px] font-bold text-amber-300 bg-amber-500/10 border border-amber-500/30 px-1.5 py-0.5 rounded-sm uppercase tracking-wider flex items-center gap-1">
                                    <i className="fa-solid fa-lock text-[8px]"></i>Eingeschränkt</span>
                            )}
                        </div>
                        {node.motto && (
