...
const DossierView: React.FC<DossierViewProps> = ({
    ...
    const handleDeleteReport = async (reportId: string) => {
        if (onDeleteReport) {
            ...
            try {
                ...
                addToast("Löschen fehlgeschlagen", <i className="fa-solid fa-xmark" />, 'bg-red-500/10 text-red-400 border-red-500/50', { description: 'Intelligence-Bericht konnte nicht gelöscht werden.' });
            }
        }
    };
    ...
    const tabs = [
        { id: 'overview' as const, label: 'Überblick', icon: 'fa-gauge-high', count: undefined as number | undefined },
            ...
            <header className={`shrink-0 relative overflow-hidden border-b border-white/5 ${threatA.heroGrad}`}>
                ...
                <div className="relative px-4 sm:px-8 pt-4 sm:pt-6 pb-4">
                    <div className="max-w-7xl mx-auto w-full">
                        ...
                        >
                            <i className="fa-solid fa-arrow-left" aria-hidden />Zurück zum Intel Hub</button>
                            ...
                            <div className="min-w-0 flex items-center gap-4">
                                ...
                                <div className="min-w-0">
                                    <div className="hidden sm:flex items-center gap-2 mb-2">
                                        ...
                                        >
                                            {copiedId ? <><i className="fa-solid fa-check text-emerald-400" aria-hidden />Kopiert</> : <><i className="fa-regular fa-copy" aria-hidden />Kopie</>}
                                        </button>
                                    </div>
                                ...
                                <div className="rounded-xl border border-white/10 bg-slate-900/40 overflow-hidden">
                                    <div className="px-5 py-3 bg-slate-950/40 border-b border-white/5 flex justify-between items-center gap-3">
                                        <div className="flex items-center gap-3 min-w-0">
                                            ...
                                            <div className="min-w-0">
                                                <h3 className="text-sm font-bold text-white">AI Taktische Analyse</h3>
                                    ...
                                    <div className="p-5 relative">
                                        {isGeneratingSummary && (
                                            <div className="absolute inset-0 bg-slate-950/80 backdrop-blur-xs flex flex-col items-center justify-center z-10">
                                                ...
                                                <p className="text-xs font-bold text-indigo-200 uppercase tracking-widest animate-pulse">Geheimdienstdaten analysieren…</p>
                                            </div>
                                        )}
                                        ...
                                        {!aiAvailable && !aiSummary && (
                                            <div className="py-10 flex flex-col items-center justify-center text-slate-500 text-center">
                                                ...
                                                <p className="text-xs font-black uppercase tracking-widest text-slate-300">AI Schlüssel nicht installiert</p>
                                        ...
                                        {aiAvailable && isLocked && !aiSummary && !humanisedError && (
                                            <div className="py-10 flex flex-col items-center justify-center text-center">
                                                ...
                                                <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Ratenbegrenzung aktiv</p>
                                        ...
                                        {aiAvailable && !aiSummary && !humanisedError && !isLocked && (
                                            <div className="py-10 flex flex-col items-center justify-center text-slate-500 text-center">
                                                ...
                                                <p className="text-xs font-black uppercase tracking-widest">Es wurde noch keine Analyse erstellt</p>
                        ...
                        <div className="space-y-6">
                                ...
                                <div className="rounded-xl border border-white/10 bg-slate-900/40 overflow-hidden">
                                    <div className="px-4 py-3 bg-slate-950/40 border-b border-white/5 flex items-center justify-between">
                                        <h3 className="text-xs font-black text-slate-300 uppercase tracking-widest flex items-center gap-2">
                                            <i className="fa-solid fa-clock-rotate-left text-amber-400" aria-hidden />Interaktionsverlauf</h3>
                                    ...
                                    <div className="max-h-[400px] overflow-y-auto custom-scrollbar divide-y divide-white/5">
                                        {requests.length > 0 ? requests.map((r: any, idx: number) => {
                                            ...
                                            <div className="py-8 flex flex-col items-center justify-center text-slate-600">
                                                ...
                                                <p className="text-[10px] font-black uppercase tracking-widest">Keine Interaktionen gespeichert</p>
                                            </div>
                                        )}
                                    </div>
                                </div>
                            ...
                            {!isOrg && operations.length > 0 && (
                                <div className="rounded-xl border border-white/10 bg-slate-900/40 overflow-hidden">
                                    <div className="px-4 py-3 bg-slate-950/40 border-b border-white/5 flex items-center justify-between">
                                        <h3 className="text-xs font-black text-slate-300 uppercase tracking-widest flex items-center gap-2">
                                            <i className="fa-solid fa-crosshairs text-emerald-400" aria-hidden />Operationen</h3>
                    ...
                    <div className="grid grid-cols-1 xl:grid-cols-2 gap-6 pb-8">
                        ...
                        {reports.length === 0 && (
                            <div className="col-span-full py-20 text-center border border-dashed border-white/10 rounded-xl bg-slate-900/30">
                                ...
                                <p className="font-black text-slate-500 uppercase tracking-widest text-sm">Es liegen keine Geheimdienstberichte vor</p>
                            </div>
                        )}
                    </div>
                )}
                    ...
                    <div className="pb-8">
                        {affiliates.length > 0 ? (
                            ...
                            <div className="text-center py-20 border border-dashed border-white/10 rounded-xl bg-slate-900/30">
                                ...
                                <p className="font-black text-slate-500 uppercase tracking-widest text-sm">Keine bekannten Zugehörigkeiten</p>
                            </div>
                        )}
                    </div>
                )}
