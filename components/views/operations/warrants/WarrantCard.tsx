            ...
            <div className="relative pl-4 pr-4 py-4 grow grid grid-cols-1 md:grid-cols-5 gap-4 min-h-0">
                ...
                <div className="md:col-span-2 flex flex-col gap-3 min-w-0">
                    <div className="p-3 rounded-lg bg-slate-950/40 border border-white/5">
                        <p className="text-[9px] font-black text-slate-500 uppercase tracking-widest mb-1.5">Belohnungswert</p>
                    ...
                    {warrant.issuedByUser && (
                        <div className="flex items-center gap-2 text-[11px] text-slate-300 min-w-0">
                            ...
                            <span className="text-slate-500 uppercase font-black tracking-widest text-[9px]">Ausgegeben</span>
                            <img
                    ...
                    {warrant.status === WarrantStatus.Claimed && warrant.claimedByUser && (
                        <div className="flex items-center gap-2 text-[11px] text-emerald-200 min-w-0 p-2 rounded-lg border border-emerald-500/20 bg-emerald-500/5">
                            ...
                            <span className="text-emerald-400/80 uppercase font-black tracking-widest text-[9px]">Behauptet</span>
                            <img
                ...
                <div className="md:col-span-3 flex flex-col gap-3 min-w-0 md:border-l md:border-white/5 md:pl-4">
                    <div className="grow min-w-0">
                        <p className="text-[9px] text-slate-500 uppercase font-black tracking-widest mb-1">Genehmigung</p>
                    ...
                    {warrant.notes && (
                        <div className="rounded-md border border-white/5 bg-slate-950/40 px-2.5 py-1.5">
                            <p className="text-[9px] text-slate-500 uppercase font-black tracking-widest mb-0.5">Feldnotizen</p>
                ...
                {canManage ? (
                    <>
                        <button
                            ...
                            title="Delete caution note"
                        >
                            <i className="fa-solid fa-trash" aria-hidden />Löschen</button>
                        <button
                        ...
                        >
                            <i className="fa-solid fa-pen-to-square mr-1.5" aria-hidden />Verwalten</button>
                    </>
                ) : (
                    <button
                    ...
                    >
                        <i className="fa-solid fa-eye mr-1.5" aria-hidden />Details anzeigen</button>
                )}
            </div>
        </div>
    );
