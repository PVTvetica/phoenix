        ...
        <div className="p-6 lg:p-8 space-y-4">
            ...
            <div className="flex flex-wrap items-center justify-between gap-3 p-4 bg-linear-to-r from-slate-800/60 to-slate-900/40 rounded-xl border border-slate-700/40">
                <div className="flex items-center gap-4">
                    <p className="text-[10px] text-slate-500 uppercase font-black tracking-[0.15em] flex items-center gap-2">
                        <i className="fa-solid fa-layer-group text-purple-400/70"></i>Ausführungsplan</p>
                        ...
                        >
                            ...
                            {group.phase ? (
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <div className="flex items-center gap-2">
                                            ...
                                            {group.phase.phaseType === 'contingency' && (
                                                <span className="text-[8px] bg-amber-500/10 text-amber-400 border border-amber-500/20 px-1.5 py-0.5 rounded-sm uppercase">Kontingenz</span>
                                            )}
                                        </div>
                                                    ...
                                                    <KebabMenu onClose={closeKebab} triggerRef={kebabTriggerRef}>
                                                        ...
                                                        <div className="flex items-center justify-between pt-2 border-t border-slate-700/50">
                                                            ...
                                                            <button onClick={() => saveKebabPhase(group.phase!.id)} disabled={kebabSaving}
                                                                ...
                                                                {kebabSaving ? <><i className="fa-solid fa-spinner animate-spin mr-1"></i>Sparen…</> : 'Save'}
                                                            </button>
                                                        </div>
                                                    </KebabMenu>
                                                )}
                                ...
                                <div className="px-5 py-3 bg-slate-800/40 border-b border-slate-700/30">
                                    <span className="text-[10px] font-black text-slate-500 uppercase tracking-widest">Allgemein (ohne Phasen)</span>
                                </div>
                            )}
                            ...
                            <div className="p-4 space-y-1">
                                ...
                                {(sortedMilestones.length > 0 || (canManage && addingMilestoneFor === key)) && (
                                    <div className="space-y-1">
                                        {sortedMilestones.length > 0 && (
                                            <p className="text-[9px] font-black text-slate-600 uppercase tracking-widest pl-1 pb-1">Meilensteine</p>
                                        )}
                                ...
                                {(sortedTasks.length > 0 || (canManage && addingTaskFor === key)) && (
                                    <div className="space-y-1">
                                        {sortedTasks.length > 0 && (
                                            <p className="text-[9px] font-black text-slate-600 uppercase tracking-widest pl-1 pb-1">Aufgaben</p>
                                        )}
                                                            ...
                                                            <div className="relative">
                                                                ...
                                                                {kebabOpen === tKey && (
                                                                    <KebabMenu onClose={closeKebab} triggerRef={kebabTriggerRef}>
                                                                        ...
                                                                        <div className="grid grid-cols-2 gap-3">
                                                                            <div>
                                                                                ...
                                                                                <select value={kebabFields.taskType || 'primary'} onChange={e => setKebabFields(f => ({ ...f, taskType: e.target.value }))} className={inputClass}>
                                                                                    ...
                                                                                    <option value="assignment">Abtretung</option>
                                                                                </select>
                                                                            </div>
                                                                            <div>
                                                                        ...
                                                                        <div>
                                                                            <label className={labelClass}>Bevollmächtigter</label>
                                ...
                                {group.milestones.length === 0 && group.tasks.length === 0 && !canManage && (
                                    <p className="text-xs text-slate-600 italic py-3 text-center">In dieser Phase gibt es keine Meilensteine ​​oder Aufgaben.</p>
                                )}
                            </div>
                        </div>
                    );
            ...
            {phases.length === 0 && entries.length === 0 && tasks.length === 0 && !canManage && (
                <div className="flex flex-col items-center justify-center py-16 text-slate-600">
                    ...
                    <p className="text-sm font-medium opacity-60">Noch kein Ausführungsplan definiert.</p>
                </div>
            )}
        </div>
    );
