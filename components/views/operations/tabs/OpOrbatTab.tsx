        ...
        <div className="p-4 md:p-6 space-y-4 flex flex-col h-full">
            ...
            <div className="flex items-center justify-between shrink-0">
                ...
                <div className="flex items-center gap-2 bg-slate-800/60 border border-slate-700/50 rounded-lg px-3 py-2">
                    <span className="text-[9px] text-slate-500 font-black uppercase tracking-wider">Bereit</span>
                ...
                <>
                    ...
                    <div className="flex flex-wrap gap-3 items-center shrink-0">
                        {operation.maxParticipants && (
                            <div className="flex items-center gap-2 bg-slate-800/60 border border-slate-700/50 rounded-lg px-3 py-2">
                                <span className="text-[9px] text-slate-500 font-black uppercase tracking-wider">Kapazität</span>
                        ...
                        {canManage && onAddParticipant && (
                            <button onClick={onAddParticipant}
                                ...
                                <i className="fa-solid fa-user-plus"></i>Teilnehmer hinzufügen</button>
                        )}
                    </div>
                    ...
                    <div className="flex gap-3 items-center shrink-0">
                        ...
                        <select value={rosterSort} onChange={e => setRosterSort(e.target.value as any)}
                            ...
                            <option value="ready">Sortieren: Fertig</option>
                            <option value="name">Sortieren: Name</option>
                            <option value="role">Sortieren: Rolle</option>
                            <option value="joined">Sortieren: Beigetreten</option>
                        </select>
                    </div>
                    ...
                    <div className="flex-1 space-y-2 overflow-y-auto custom-scrollbar pr-1">
                        {sortedRosterParticipants.length > 0 ? (
                            ...
                            <div className="flex flex-col items-center justify-center h-40 text-slate-600 opacity-50">
                                ...
                                <p className="text-xs italic">Keine aktiven Teilnehmer.</p>
                            </div>
                        )}
                    </div>
                </>
                    ...
                    {canManage && (
                        <div className="flex items-center justify-end shrink-0">
                            <button onClick={() => openAddForm()} className="text-[10px] font-bold text-purple-300 hover:text-purple-200 uppercase">
                                <i className="fa-solid fa-plus mr-1"></i>Knoten hinzufügen</button>
                        </div>
                    )}
                    ...
                    {showForm && (
                        <div className="bg-slate-800/40 border border-slate-700/50 rounded-lg p-4 space-y-3 animate-fade-in shrink-0">
                            <div className="grid grid-cols-3 gap-3">
                                ...
                                <div>
                                    <label className={labelClass}>Knotentyp</label>
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                <div>
                                    <label className={labelClass}>Übergeordneter Knoten</label>
                                ...
                                <div>
                                    <label className={labelClass}>Teilnehmer zuweisen</label>
                            ...
                            <div className="flex justify-end gap-2">
                                <button onClick={() => { setShowForm(false); setEditingNode(null); }} className="text-xs text-slate-400 hover:text-white px-3 py-1.5">Abbrechen</button>
