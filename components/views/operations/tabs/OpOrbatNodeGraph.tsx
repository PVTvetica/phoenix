...
const nodeTypeConfig: Record<string, { icon: string; color: string; label: string }> = {
    command: { icon: 'fa-solid fa-star', color: '#f59e0b', label: 'Befehl' },
    unit: { icon: 'fa-solid fa-people-group', color: '#3b82f6', label: 'Einheit' },
                                                ...
                                                <div className="flex items-center gap-2 mt-1.5 text-[10px] text-slate-500 flex-wrap">
                                                    ...
                                                    {participant && (participant.ship || participant.shipUtilized) ? (
                                                        ...
                                                        <span className="flex items-center gap-1 text-slate-400 bg-slate-500/10 border border-slate-500/20 px-1.5 py-0.5 rounded-sm">
                                                            <i className="fa-solid fa-person-walking text-[8px]"></i>Zu Fuß</span>
                                                    ) : null}
                                                    {!n.node.assignedUser && !n.node.assignedUnit && <span className="text-slate-600 italic">Nicht zugewiesen</span>}
                                                </div>
                                            </div>
                                        </div>
                                        {canManage && (
                                            <div className="flex gap-1 opacity-0 group-hover/node:opacity-100 transition-opacity shrink-0">
                                                ...
                                                <button onClick={(e) => { e.stopPropagation(); onEditNode(n.node); }}
                                                    className="w-6 h-6 flex items-center justify-center text-slate-500 hover:text-white hover:bg-slate-700 rounded-sm transition-colors text-[10px]" title="Bearbeiten">
                                                    <i className="fa-solid fa-pen"></i>
                                                </button>
                                                <button onClick={(e) => { e.stopPropagation(); onDeleteNode(n.node.id); }}
                                                    className="w-6 h-6 flex items-center justify-center text-red-500 hover:text-red-400 hover:bg-red-500/10 rounded-sm transition-colors text-[10px]" title="Löschen">
                                ...
                                >
                                    ...
                                    <div className="min-w-0 flex-1">
                                        ...
                                        {participant ? (
                                            ...
                                            <p className="text-[9px] text-slate-600 italic">Nicht zugewiesen</p>
                                        )}
                                        {participant && (participant.ship || participant.shipUtilized) ? (
                                            ...
                                            <div className="flex items-center gap-1 mt-0.5">
                                                ...
                                                <span className="text-[8px] text-slate-500">Zu Fuß</span>
                                            </div>
                                        ) : null}
                                    </div>
                                    {participant?.isReady && (
                                    ...
                                    {canManage && (
                                        <div className="flex gap-0.5 opacity-0 group-hover/pos:opacity-100 transition-opacity shrink-0">
                                            <button onClick={(e) => { e.stopPropagation(); onEditNode(n.node); }}
                                                className="w-5 h-5 flex items-center justify-center text-slate-500 hover:text-white hover:bg-slate-700 rounded-sm transition-colors text-[9px]" title="Bearbeiten">
                                                <i className="fa-solid fa-pen"></i>
                                            </button>
                                            <button onClick={(e) => { e.stopPropagation(); onDeleteNode(n.node.id); }}
                                                className="w-5 h-5 flex items-center justify-center text-red-500 hover:text-red-400 hover:bg-red-500/10 rounded-sm transition-colors text-[9px]" title="Löschen">
                                                <i className="fa-solid fa-trash"></i>
                                            </button>
                                        </div>
                                    )}
                    ...
                    {nodes.length === 0 && (
                        <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                            <div className="text-center text-slate-600 opacity-50">
                                ...
                                <p className="text-sm font-medium">ORBAT Struktur</p>
                            ...
                            <div key={p.userId} className="flex items-center gap-2 bg-slate-800/50 border border-slate-700/30 rounded-lg px-2.5 py-1.5">
                                ...
                                {(p.ship || p.shipUtilized) ? (
                                    ...
                                    <span className="text-[8px] text-slate-500 flex items-center gap-1">
                                        <i className="fa-solid fa-person-walking text-[7px]"></i>Zu Fuß</span>
                                )}
