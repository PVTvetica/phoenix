    ...
    const handleDelete = async (e: React.MouseEvent) => {
        ...
        if (confirmed) {
            ...
            try { await deleteRequest(request.id); }
                ...
                addToast("Löschen fehlgeschlagen", <i className="fa-solid fa-circle-exclamation"></i>, 'bg-red-500/10 text-red-400 border-red-500/50', { description: 'Serviceanfrage konnte nicht gelöscht werden.' });
            } finally { setLoadingAction(null); }
        }
    };
            ...
            <div className="relative pl-4 pr-4 py-4 grow grid grid-cols-1 md:grid-cols-5 gap-4 min-h-0">
                ...
                <div className="md:col-span-2 flex flex-col gap-3 min-w-0">
                    ...
                    <div className="space-y-2">
                        <div>
                            <p className="text-[9px] text-slate-500 uppercase font-black tracking-widest mb-1">Standort</p>
