...
export default function FeatureTabs() {
    ...
    const tabs: Tab[] = useMemo(() => [
        { key: 'operations',  label: 'Operationen',  icon: 'fa-crosshairs',     render: () => <OperationsPanel /> },
        { key: 'requests',    label: 'Anfragen',    icon: 'fa-clipboard-list', render: () => <RequestsPanel /> },
        { key: 'intel',       label: 'Intel-Netz',   icon: 'fa-satellite-dish', render: () => <IntelPanel /> },
        ...(governmentEnabled  ? [{ key: 'government'  as const, label: 'Regierung',  icon: 'fa-landmark',       render: () => <GovernmentPanel /> }]  : []),
    ], [governmentEnabled]);
