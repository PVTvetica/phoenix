...
const REASON_OPTIONS: ReasonOption[] = [
    {
        key: 'restock',
        label: 'Restock',
        description: 'Neuer Bestand eingetroffen. Erhöht den Bestand.',
        serverReason: 'adjust',
        deltaSign: 'positive',
        destructive: false,
        notesRequired: false,
    },
    {
        ...
        description: 'Inventurfehler korrigieren. Kann nach oben oder unten gehen.',
        serverReason: 'adjust',
        deltaSign: 'either',
        destructive: false,
        notesRequired: false,
    },
    {
        ...
        description: 'Bestand fehlt. Reduziert den Bestand.',
        serverReason: 'loss',
        deltaSign: 'negative',
        destructive: true,
        notesRequired: true,
    },
    {
        key: 'destruction',
        label: 'Destruction',
        description: 'Bestand vernichtet (Kampf, Unfall, Verfall). Reduziert den Bestand.',
            ...
            <div className="relative w-full max-w-lg bg-slate-950/95 border border-white/10 rounded-xl shadow-2xl flex flex-col max-h-[90vh] overflow-hidden">
                ...
                <div className="flex items-center justify-between px-5 py-4 border-b border-white/10">
                    <div className="min-w-0">
                        <p className="text-[10px] font-black text-slate-500 uppercase tracking-[0.25em]">Lagerbestand anpassen</p>
                ...
                <div className="flex items-center justify-end gap-2 px-5 py-3 border-t border-white/10 bg-slate-900/40">
                    ...
                    >
                        {submitting ? <><i className="fa-solid fa-spinner fa-spin mr-1.5" />Sparen…</> : <><i className="fa-solid fa-check mr-1.5" />Anwenden</>}
                    </button>
                </div>
            </div>
        </div>
