...
const OUTCOMES: { key: ReturnOutcome; label: string }[] = [
    ...
    { key: 'returned_late', label: 'Spät' },
    { key: 'returned_damaged', label: 'Beschädigt' },
];
    ...
    return (
        ...
        >
            <div className="p-5 space-y-4">
                {/* Default outcome */}
                <div>
                    <span className="text-[10px] font-mono uppercase tracking-widest text-slate-400">Standardergebnis<span className="text-slate-600">· applies to selected lines</span>
                    </span>
                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <div className="text-sm text-white truncate font-bold">
                                            {iss.quantity}× {name}
                                            {iss.isOverdue && <span className="ml-2 text-[9px] font-bold uppercase tracking-widest text-rose-300">Überfällig</span>}
                                        </div>
