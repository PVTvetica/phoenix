    ...
    return (
        <div className="h-full flex flex-col overflow-hidden animate-fade-in">
            <HeroShell
                ...
                chipAccent="cyan"
                title="Externe Tools"
                subtitle="Drittanbieter-Ressourcen und Tools für deine Zugriffsstufe."
                ...
                {visibleTools.length > 0 ? (
                    ...
                    <div className="rounded-xl border border-dashed border-slate-700 bg-slate-900/30">
                        <EmptyState
                            icon="fa-folder-open"
                            accent="cyan"
                            heading="Keine externen Tools verfügbar"
                            description="Für deine Zugriffsstufe sind keine Drittanbieter-Tools konfiguriert. Kontaktiere einen Administrator für Zugang."
                        />
                    </div>
                )}
            </div>
