            ...
            <div className="w-full max-w-lg relative z-10 animate-fade-in-up space-y-6">
                <div className="bg-slate-900/60 backdrop-blur-xl border border-white/10 rounded-2xl shadow-2xl overflow-hidden relative">
                    ...
                    <div className="p-8 text-center border-b border-white/5 bg-white/5">
                        ...
                        <h1 className="text-2xl font-black text-white tracking-tight uppercase mb-1">Identitätsprüfung</h1>
                    ...
                    <div className="p-8 space-y-8">
                        <div className="flex items-center gap-4 bg-black/40 p-4 rounded-xl border border-slate-700/50 shadow-inner">
                            ...
                            <div className="min-w-0">
                                <p className="text-[10px] text-slate-500 uppercase font-black tracking-widest mb-0.5">Identität verankern</p>
                        ...
                        <div className="space-y-5">
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    <p className="text-slate-300 text-sm font-bold">Zugriff auf RSI-Steuerung</p>
                                    <p className="text-xs text-slate-500 mt-1">Besuchen<a href="https://robertsspaceindustries.com/account/profile" target="_blank" rel="noopener noreferrer" className="text-sky-400 hover:underline">rsi.com/account/profile</a> &rarr; Settings.</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div className="w-full">
                                    <p className="text-slate-300 text-sm font-bold mb-3">Verifizierungsnutzlast synchronisieren</p>
                                    ...
                                    <p className="text-[10px] text-slate-500 mt-2 italic px-1">Füge es in Deinen RSI Abschnitt „Bio“ ein und übernehmen du die Änderungen.</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    <p className="text-slate-300 text-sm font-bold">Identitäts-Handshake einleiten</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="pt-4 flex flex-col gap-4">
                            ...
                            >
                                {isLoading ? (
                                    <><i className="fa-solid fa-circle-notch animate-spin mr-2" />Signal wird synchronisiert…</>
                                ) : "Verify Profile"}
                            </button>
                    ...
                    <div className="bg-black/20 p-5 border-t border-white/5 text-center flex justify-center">
                        <button onClick={logout} className="text-[9px] text-slate-600 hover:text-red-400 uppercase font-black tracking-widest transition-colors flex items-center gap-2">
                            <i className="fa-solid fa-power-off"></i>Uplink beenden</button>
                    </div>
                </div>
            </div>
        </div>
