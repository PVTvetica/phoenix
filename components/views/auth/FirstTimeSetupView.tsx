        ...
        <div className="relative flex flex-col min-h-dvh bg-slate-950 text-slate-200 font-sans overflow-hidden animate-fade-in">
            ...
            <div className="relative z-10 flex-1 flex items-center justify-center px-5 sm:px-8 py-6">
                <div className="w-full max-w-md flex flex-col items-center text-center">
                    ...
                    <p className="text-[11px] text-amber-300/70 font-mono uppercase tracking-[0.3em] mb-5">Systeminitialisierung</p>
                    <div className="h-px w-20 bg-linear-to-r from-transparent via-amber-500 to-transparent opacity-60 mb-6" />

                    <p className="text-sm text-slate-400 leading-relaxed mb-6 max-w-sm">
                        {isAuthenticated
                            ? <>Identität überprüft. Gib Deine ein<span className="text-slate-200 font-bold">Setup-Code</span> to complete administrator setup.</>
                    ...
                    {!isAuthenticated ? (
                        <div className="w-full space-y-3">
                            ...
                            >
                                ...
                                <span className="relative z-10 uppercase tracking-wider">Authentifizieren & Beanspruchen</span>
                            </button>

                            <div className="p-3 bg-black/30 rounded-lg border border-slate-700/50 text-[11px] text-slate-500 font-mono text-left">
                                <p className="font-bold text-slate-400 mb-1 uppercase tracking-wider text-[10px]">Konfigurations-Debug</p>
                                <p className="break-all">Weiterleitungs-URI:<span className="text-amber-300 select-all">{window.location.origin}</span></p>
                        ...
                        <form onSubmit={handleClaim} className="w-full space-y-3">
                            ...
                            >
                                {isSubmitting
                                    ? <><i className="fa-solid fa-circle-notch animate-spin mr-2" aria-hidden />Überprüfung…</>
                                    : 'Finalize Setup'
                                }
                            </button>
