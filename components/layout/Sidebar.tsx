                ...
                <div className="flex flex-col h-full">
                    ...
                    <div className="flex-1 py-6 overflow-y-auto overflow-x-hidden custom-scrollbar text-left">
                        {(() => {
                            ...
                            return (
                                <nav className="px-2">
                                    <SidebarGroup
                                        id="command" label="Kommando & Ops" icon="fa-satellite-dish" accent="sky"
                                    ...
                                    <SidebarGroup
                                        id="org" label="Organisationsverwaltung" icon="fa-people-group" accent="indigo"
                                    ...
                                    <SidebarGroup
                                        id="economy" label="Wirtschaft" icon="fa-coins" accent="amber"
                                    ...
                                    <SidebarGroup
                                        id="resources" label="Ressourcen" icon="fa-toolbox" accent="slate"
                    ...
                    <div className="shrink-0 p-4 border-t border-white/5 bg-slate-900/50 space-y-3">
                        ...
                        `}
                            ...
                            >
                                <span className="relative z-10 flex items-center justify-center gap-2">
                                    ...
                                    {(!isSidebarCollapsed || isMobileOpen) && 'EAM SENDEN'}
                                </span>
                            </button>
                        )}
                        ...
                        {hasPermission('user:toggle_duty') && (
                            <div className="">
                                {(!isSidebarCollapsed || isMobileOpen) && (
                                    <p className="text-[10px] uppercase font-black text-slate-500 mb-2 tracking-wider text-center">Statuskontrolle</p>
                                )}
                                <button
                            ...
                            ${isSidebarCollapsed && !isMobileOpen ? 'h-10 w-10 rounded-xl flex items-center justify-center mx-auto' : 'py-3 px-4 rounded-lg text-xs uppercase tracking-widest'}`}
                                    title={liveUser.isDuty ? "Vom Dienst gehen" : "Zum Dienst antreten"}
                                >
                                    <span className="relative z-10 flex items-center justify-center gap-2 text-center">
                                        {isTogglingDuty ? (
                                            <>
                                                <i className="fa-solid fa-circle-notch animate-spin"></i>
                                                {(!isSidebarCollapsed || isMobileOpen) && 'WIRD AKTUALISIERT…'}
                                            </>
                                        ) : (
                                            <>
                                                <i className="fa-solid fa-power-off"></i>
                                                {(!isSidebarCollapsed || isMobileOpen) && (liveUser.isDuty ? 'IM DIENST' : 'NICHT IM DIENST')}
                                            </>
                                        )}
                                    </span>
                                ...
                                {showIdleWarning && (!isSidebarCollapsed || isMobileOpen) && (
                                    <p className="text-[9px] text-amber-500 text-center mt-2 font-mono uppercase animate-pulse">
                                        Leerlauf-Timeout: {minsRemaining} Min.
                                    </p>
                                )}
                            </div>
                        )}
                        ...
                        {canInstall && !isInstalled && (
                            ...
                            >
                                <span className="flex items-center justify-center gap-2">
                                    ...
                                    {(!isSidebarCollapsed || isMobileOpen) && 'App installieren'}
                                </span>
                            </button>
                        )}
