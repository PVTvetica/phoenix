                ...
                <div className="flex flex-wrap items-center gap-2">
                    ...
                    <div className="flex bg-slate-900/60 rounded-lg border border-slate-700 p-0.5">
                        {matchKeyword && (
                            ...
                            >
                                <i className="fa-solid fa-bullseye mr-1"></i>Übereinstimmen</button>
                        )}
                        <button
                ...
                {onDutyMembers.length > 0 ? (
                    ...
                    <div className="flex items-center justify-center px-6 py-8">
                        <EmptyState
                            icon="fa-user-slash"
                            accent="emerald"
                            heading="Keine passenden Mitglieder im Dienst"
                ...
                <div className="shrink-0 border-t border-slate-800/60">
                    ...
                    >
                        ...
                        {allowDutyToggle && showOffDuty && (
                            <span className="text-[9px] font-mono text-slate-500 normal-case">Klicken<i className="fa-solid fa-power-off mx-1"></i> to bring on duty
                            </span>
                        )}
                    </button>
                    {showOffDuty && (
                        <div className="max-h-64 overflow-y-auto custom-scrollbar border-t border-slate-800/40">
                            {!hasActiveFilter ? (
                                ...
                                <p className="text-[11px] text-slate-600 italic px-4 py-3">Keine dienstfreien Mitglieder entsprechen den aktuellen Filtern.</p>
                            )}
                        </div>
                    )}
                </div>
...
const OffDutyRow: React.FC<OffDutyRowProps> = ({ member, isDutyPending, allowDutyToggle, onDutyToggle }) => (
    <div className="flex items-center justify-between px-4 py-2 border-b border-slate-800/30 opacity-60 hover:opacity-90 transition-opacity">
        ...
        {allowDutyToggle && (
            ...
            >
                <i className={`fa-solid ${isDutyPending ? 'fa-circle-notch animate-spin' : 'fa-power-off'} mr-1 text-[9px]`}></i>Her damit</button>
        )}
    </div>
);
