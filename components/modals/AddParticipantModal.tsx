...
const AddParticipantModal: React.FC<AddParticipantModalProps> = ({ isOpen, onClose, operation }) => {
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            addToast("Fehler", <i className="fa-solid fa-xmark"></i>, "bg-red-500/10 text-red-400 border-red-500/50", { description: "Beim Hinzufügen von Teilnehmern ist ein Fehler aufgetreten. Bitte versuche es erneut." });
        } finally {
            setIsLoading(false);
        }
    };
                ...
                <div className="p-4">
                    ...
                    <div className="max-h-[50vh] overflow-y-auto custom-scrollbar space-y-2 pr-1">
                        ...
                        {availableMembers.length === 0 && (
                            <p className="text-center text-slate-500 text-xs italic py-8">Keine verfügbaren Mitglieder gefunden.</p>
                        )}
                    </div>
                </div>
