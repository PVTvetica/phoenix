        ...
        >
            <form onSubmit={handleSubmit} className="flex flex-col h-full">
                <div className="p-6 space-y-5 overflow-y-auto custom-scrollbar flex-1">
                    <div>
                        <label className={labelClass}>Titel<span className="text-slate-600">({title.length}/120)</span></label>
                        <input
                            type="text"
                            value={title}
                    ...
                    <div>
                        <label className={labelClass}>Körper<span className="text-slate-600">({body.length}/500)</span></label>
                        <textarea
                            value={body}
                    ...
                    <div>
                        <label className={labelClass}>Standort<span className="text-slate-600">(optional)</span></label>
                        <input
                            type="text"
                            value={location}
                    ...
                    <div className="bg-slate-950/50 p-4 rounded-xl border border-slate-800 space-y-4">
                        <h4 className="text-[10px] font-black text-sky-500 uppercase tracking-widest flex items-center gap-2">
                            <i className="fa-solid fa-lock"></i>Klassifizierung und Datenschutz</h4>
                        <div className="grid grid-cols-2 gap-4">
                            <div>
                                <label className={labelClass}>Klassifizierungsstufe</label>
                        ...
                        <div className="pt-3 border-t border-slate-800/70">
                            ...
                            >
                                <span className="flex items-center gap-2">
                                    <i className="fa-solid fa-handshake"></i>Mit Verbündeten teilen</span>
