...
const CreateJobModal: React.FC<CreateJobModalProps> = ({ isOpen, onClose, job }) => {
    ...
    return (
        <WindowFrame
            ...
            subtitle="Rekrutierungskontrolle"
        ...
        >
            <form onSubmit={handleSubmit} className="flex flex-col h-full">
                <div className="p-6 space-y-5">
                    <div>
                        <label className="block text-[10px] font-black text-emerald-300 uppercase tracking-widest mb-1.5">Verknüpfte Rolle (optional)</label>
                        <select
                            value={positionId}
                    ...
                    <div className="grid grid-cols-2 gap-5">
                        <div>
                            <label className={labelClass}>Berufsbezeichnung</label>
                            <input
                                type="text"
                                value={title}
                        ...
                        <div>
                            <label className={labelClass}>Einheit / Abteilung</label>
                            <select
                                value={department}
                            ...
                            >
                                ...
                                <option value="General Pool">Allgemeiner Pool</option>
