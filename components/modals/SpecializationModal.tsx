...
const SpecializationModal: React.FC<SpecializationModalProps> = ({ isOpen, onClose, tag }) => {
    ...
    const handleSubmit = useCallback(async (e: React.FormEvent) => {
        ...
        try {
            ...
            addToast("Speichern fehlgeschlagen", <i className="fa-solid fa-xmark"></i>, "bg-red-500/10 text-red-400 border-red-500/50", { description: "Beim Speichern des Tags ist ein Fehler aufgetreten. Bitte versuche es erneut." });
            setIsLoading(false);
        }
        ...
        >
            <form onSubmit={handleSubmit} className="flex flex-col h-full">
                <div className="p-6 space-y-5 overflow-y-auto custom-scrollbar flex-1">
                    ...
                    <div>
                        <label className={labelClass}>Symbol (optional)</label>
                        <AwardIconInput
                            icon={icon}
