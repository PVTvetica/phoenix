...
const AwardCommendationModal: React.FC<AwardCommendationModalProps> = ({ isOpen, onClose, commendation }) => {
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            addToast("Fehler", <i className="fa-solid fa-xmark"></i>, "bg-red-500/10 text-red-400 border-red-500/50", { description: "Beim Verleihen von Auszeichnungen ist ein Fehler aufgetreten. Bitte versuche es erneut." });
        } finally {
            setIsLoading(false);
        }
    };
            ...
            <div className="flex flex-col h-full">
                ...
                <div className="p-4 flex-1 overflow-hidden flex flex-col space-y-4">
                    ...
                    <div className="flex-1 overflow-y-auto custom-scrollbar space-y-2 pr-1">
                        <p className="text-xs text-slate-400 mb-2">Wähle Mitglieder aus, denen du diese Auszeichnung verleihen möchten.</p>
                        {members.map(member => {
