...
const ExternalToolModal: React.FC<ExternalToolModalProps> = ({ isOpen, onClose, tool }) => {
    ...
    const handleSubmit = useCallback(async (e: React.FormEvent) => {
        ...
        try {
            ...
            addToast("Speichern fehlgeschlagen", <i className="fa-solid fa-xmark"></i>, "bg-red-500/10 text-red-400 border-red-500/50", { description: "Beim Speichern des Tools ist ein Fehler aufgetreten. Bitte versuche es erneut." });
            setIsLoading(false);
        }
        ...
        >
            <form onSubmit={handleSubmit} className="flex flex-col h-full">
                <div className="p-6 space-y-5">
                    ...
                    <div>
                        <label className={labelClass}>Kategorie (optional)</label>
                        <input
                            type="text"
                            value={category}
                    ...
                    <div>
                        <label className={labelClass}>Font Awesome Symbol</label>
                    ...
                    <div>
                        <label className={labelClass}>Publikumszugang</label>
