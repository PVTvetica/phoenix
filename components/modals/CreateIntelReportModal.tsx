...
const CreateIntelReportModal: React.FC<CreateIntelReportModalProps> = ({ isOpen, onClose, onMinimize, onSuccess, initialData }) => {
    ...
    const handleSubmit = useCallback(async (e: React.FormEvent) => {
        ...
        try {
            ...
            console.error(err);
            addToast("Fehler", <i className="fa-solid fa-xmark"></i>, "bg-red-500/10 text-red-400 border-red-500/50", { description: "Intel-Bericht konnte nicht erstellt werden. Bitte versuche es erneut." });
        } finally {
            setIsLoading(false);
        }
