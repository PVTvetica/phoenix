...
const CompleteRequestModal: React.FC<CompleteRequestModalProps> = ({ isOpen, onClose, request }) => {
    ...
    const handleSubmit = useCallback(async (e: React.FormEvent) => {
        ...
        try {
            ...
            addToast("Fehler", <i className="fa-solid fa-xmark"></i>, "bg-red-500/10 text-red-400 border-red-500/50", { description: "Beim Abschließen der Anfrage ist ein Fehler aufgetreten. Bitte versuche es erneut." });
            setIsLoading(false);
        }
    ...
    return (
        <>
            <WindowFrame
                ...
                subtitle="Abschließen & archivieren"
                ...
                <form onSubmit={handleSubmit} className="flex flex-col h-full">
                    <div className="p-6 space-y-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <label className={labelClass}>UEC Verdient</label>
                        ...
                        <div>
                            <label className={labelClass}>Beurteilung des Kundenverhaltens</label>
                        ...
                        <div>
                            <label className={labelClass}>After-Action-Bericht</label>
                            <textarea
                                value={notes}
