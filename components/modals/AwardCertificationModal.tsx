...
const AwardCertificationModal: React.FC<AwardCertificationModalProps> = ({ isOpen, onClose, certification }) => {
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            addToast("Fehler", <i className="fa-solid fa-xmark"></i>, "bg-red-500/10 text-red-400 border-red-500/50", { description: "Beim Verleihen von Zertifizierungen ist ein Fehler aufgetreten. Bitte versuche es erneut." });
        } finally {
            setIsLoading(false);
        }
    };
