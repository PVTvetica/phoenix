            ...
            <div className="flex flex-col h-full">
                <div className="p-6 space-y-5 overflow-y-auto">
                        ...
                        <div className="flex items-center gap-1.5">
                            {isFromAlly ? (
                                <>
                                    ...
                                    <span className="text-[9px] font-mono text-emerald-400 uppercase font-black">VERBÜNDETE</span>
                                </>
                    ...
                    {bulletin.location && (
                        <div className="bg-slate-950/30 p-3 rounded-lg border border-slate-800/50">
                            <p className="text-[10px] uppercase font-black text-slate-500 tracking-wider mb-1">Standort</p>
                            <div className="flex items-center gap-2">
                    ...
                    <div>
                        <p className="text-[10px] uppercase font-black text-slate-500 tracking-wider mb-1.5">Einstufung</p>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        ...
                        <div className="bg-slate-950/20 p-3 rounded-lg border border-slate-800/30">
                            <p className="text-[10px] uppercase font-black text-slate-500 tracking-wider mb-1">Gepostet</p>
                ...
                <div className="p-4 border-t border-white/5 bg-slate-900/50 flex justify-end gap-3 rounded-b-xl">
                    ...
                    {canDelete && onDelete && (
                        ...
                        >
                            <i className="fa-solid fa-trash-can mr-2"></i>Löschen</button>
                    )}
                </div>
            </div>
        </WindowFrame>
