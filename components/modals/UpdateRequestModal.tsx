...
const UpdateRequestModal: React.FC<UpdateRequestModalProps> = ({ isOpen, onClose, request }) => {
    ...
    const handleSubmit = useCallback(async (e: React.FormEvent) => {
        ...
        try {
            ...
            addToast("Fehler", <i className="fa-solid fa-xmark"></i>, "bg-red-500/10 text-red-400 border-red-500/50", { description: "Beim Aktualisieren des Status ist ein Fehler aufgetreten. Bitte versuche es erneut." });
            setIsLoading(false);
        }
    ...
    return (
        <WindowFrame
            ...
            subtitle="Manueller Log-Eintrag"
        ...
        >
            <form onSubmit={handleSubmit} className="flex flex-col h-full">
                <div className="p-6 space-y-6">
                    <div>
                        <label className={labelClass}>Anforderungsstatus</label>
                        <select
                            value={status}
                    ...
                    {isCompletion && (
                        <div className="space-y-6 pt-6 border-t border-slate-800 animate-fade-in">
                            ...
                            <div>
                                <label className={labelClass}>Kundenverhalten</label>
