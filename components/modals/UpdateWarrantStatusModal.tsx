    ...
    const handleSubmit = useCallback(async (e: React.FormEvent) => {
        ...
        if (targetRsiHandle.trim() && reason.trim() && !isNaN(reward) && reward > 0) {
            ...
            try {
                ...
                addToast("Fehler", <i className="fa-solid fa-xmark"></i>, "bg-red-500/10 text-red-400 border-red-500/50", { description: "Beim Aktualisieren der Vorsichtsmitteilung ist ein Fehler aufgetreten. Bitte versuche es erneut." });
                setIsLoading(false);
            }
        }
        ...
        >
            <form onSubmit={handleSubmit} className="flex flex-col h-full">
                <div className="p-6 space-y-5">
                    ...
                    <div>
                        <label className={labelClass}>Ziel-RSI-Handle</label>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                        ...
                        <div>
                            <label className={labelClass}>UEC Belohnung</label>
                    ...
                    <div className="border-t border-slate-700/50 pt-5 space-y-5">
                        <div>
                            <label className={labelClass}>Neuer Status</label>
