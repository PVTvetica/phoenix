            ...
            <div className="flex flex-col h-full">
                <div className="p-6 space-y-5 overflow-y-auto custom-scrollbar">
                    ...
                    <div className="flex items-start gap-4">
                        ...
                        <div className="min-w-0 flex-1">
                            ...
                            {hasIntelDossier && (
                                ...
                                >
                                    <i className="fa-solid fa-folder-open text-[9px]"></i>Intel-Dossier ansehen</button>
                            )}
                        </div>
                    ...
                    <div className="bg-slate-950/30 p-4 rounded-lg border border-slate-800/50">
                        <p className="text-[10px] uppercase font-black text-slate-500 tracking-wider mb-1">Belohnungswert</p>
                    ...
                    {/* Reason */}
                    <div>
                        <p className="text-[10px] uppercase font-black text-slate-500 tracking-wider mb-1.5">Genehmigung</p>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        <div className="bg-slate-950/20 p-3 rounded-lg border border-slate-800/30">
                            <p className="text-[10px] uppercase font-black text-slate-500 tracking-wider mb-1">Ausgestellt von</p>
                        ...
                        <div className="bg-slate-950/20 p-3 rounded-lg border border-slate-800/30">
                            <p className="text-[10px] uppercase font-black text-slate-500 tracking-wider mb-1">Ausgestellt am</p>
                    ...
                    {warrant.claimedByUser && (
                        <div className="bg-green-900/10 p-3 rounded-lg border border-green-500/20">
                            <p className="text-[10px] uppercase font-black text-green-500/70 tracking-wider mb-1">Beansprucht von</p>
                            <div className="flex items-center gap-2">
                    ...
                    <div>
                        ...
                        {canPostNote && (
                            <div className="bg-slate-950/30 rounded-lg border border-slate-800/50 p-2.5 mb-2">
                                ...
                                <div className="flex items-center justify-between gap-2 mt-1.5">
                                    <span className="text-[9px] text-slate-600 italic">Gepostet als<span className="text-slate-400 font-bold">{currentUser?.name}</span>
                                    </span>
                                    <button
                                    ...
                                    >
                                        {posting
                                            ? <><i className="fa-solid fa-spinner animate-spin"></i>Veröffentlichung</>
                                            : <><i className="fa-solid fa-paper-plane"></i>Notiz posten</>}
                                    </button>
                                </div>
                            </div>
                        )}
                        ...
                        {notes.length > 0 ? (
                            ...
                            <div className="bg-slate-950/20 rounded-lg border border-slate-800/30 p-2.5">
                                <p className="text-[9px] text-slate-600 italic mb-1">Vermächtnisvermerk (vor der Namensnennung)</p>
                    ...
                    {warrant.sourceFeedLabel && (
                        <div className="flex items-center gap-2 text-xs bg-sky-900/10 p-2.5 rounded-lg border border-sky-500/20">
                            ...
                            <span className="text-sky-300 font-bold">Externe Quelle:</span>
                ...
                <div className="p-4 border-t border-white/5 bg-slate-900/50 flex justify-end gap-3 rounded-b-xl">
                    <button onClick={onClose} className="px-4 py-2 text-xs font-bold uppercase text-slate-400 hover:text-white transition-colors">Schließen</button>
                    {canManage && onEdit && (
                        <button
                            onClick={onEdit}
                        ...
                        >
                            <i className="fa-solid fa-pen mr-2"></i>Achtung bearbeiten</button>
                    )}
                </div>
            </div>
        </WindowFrame>
