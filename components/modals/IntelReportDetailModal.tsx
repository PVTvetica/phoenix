...
const IntelReportDetailModal: React.FC<IntelReportDetailModalProps> = ({ isOpen, onClose, onMinimize, report, onViewDossier, onDelete, onUpdate, initialOffset }) => {
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            addToast("Aktualisierung fehlgeschlagen", <i className="fa-solid fa-xmark"></i>, "bg-red-500/10 text-red-400 border-red-500/50", { description: "Intel-Bericht konnte nicht aktualisiert werden. Bitte versuche es erneut." });
        } finally {
            setIsLoading(false);
        }
    };
